...
$_GET['emojiID']="838";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="derelict house emoji" description = "derelict house emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="derelict house emoji">🏚️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about derelict house emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="derelict house emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🏚️</dd>
                                </dl>
...
<head>
    ...
    <title>derelict house emoji 🏚️ emoji 🏚️🏚️ copy and paste 🏚️ emoji 🏚️ emoji 🏚️🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="derelict house emoji 🏚️🏚️🏚️🏚️ Copy and paste & Search for any emojis 🏚️🏚️🏚️(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="derelict house emoji 🏚️ emoji 🏚️🏚️ copy and paste 🏚️ emoji 🏚️ emoji 🏚️🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"derelict house emoji 🏚️🏚️🏚️🏚️ Copy and paste & Search for any emojis 🏚️🏚️🏚️(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
