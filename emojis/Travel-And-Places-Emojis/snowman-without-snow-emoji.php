...
$_GET['emojiID']="1027";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="snowman without snow emoji" description = "snowman without snow emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="snowman without snow emoji">⛄</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about snowman without snow emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="snowman without snow emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>⛄</dd>
                                </dl>
...
<head>
    ...
    <title>snowman without snow emoji ⛄ emoji ⛄⛄ copy and paste ⛄ emoji ⛄ emoji ⛄🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="snowman without snow emoji ⛄⛄⛄⛄ Copy and paste & Search for any emojis ⛄⛄⛄(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="snowman without snow emoji ⛄ emoji ⛄⛄ copy and paste ⛄ emoji ⛄ emoji ⛄🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"snowman without snow emoji ⛄⛄⛄⛄ Copy and paste & Search for any emojis ⛄⛄⛄(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
