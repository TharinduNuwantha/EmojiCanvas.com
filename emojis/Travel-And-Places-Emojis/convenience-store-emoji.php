...
$_GET['emojiID']="848";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="convenience store emoji" description = "convenience store emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="convenience store emoji">🏪</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about convenience store emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="convenience store emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🏪</dd>
                                </dl>
...
<head>
    ...
    <title>convenience store emoji 🏪 emoji 🏪🏪 copy and paste 🏪 emoji 🏪 emoji 🏪🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="convenience store emoji 🏪🏪🏪🏪 Copy and paste & Search for any emojis 🏪🏪🏪(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="convenience store emoji 🏪 emoji 🏪🏪 copy and paste 🏪 emoji 🏪 emoji 🏪🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"convenience store emoji 🏪🏪🏪🏪 Copy and paste & Search for any emojis 🏪🏪🏪(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
