...
$_GET['emojiID']="1022";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="umbrella with rain drops emoji" description = "umbrella with rain drops emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="umbrella with rain drops emoji">☔</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about umbrella with rain drops emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="umbrella with rain drops emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>☔</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>umbrella with rain drops</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Travel & Places</dd>
...
<head>
    ...
    <title>umbrella with rain drops emoji ☔ emoji ☔☔ copy and paste ☔ emoji ☔ emoji ☔🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="umbrella with rain drops emoji ☔☔☔☔ Copy and paste & Search for any emojis ☔☔☔(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="umbrella with rain drops emoji ☔ emoji ☔☔ copy and paste ☔ emoji ☔ emoji ☔🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"umbrella with rain drops emoji ☔☔☔☔ Copy and paste & Search for any emojis ☔☔☔(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
