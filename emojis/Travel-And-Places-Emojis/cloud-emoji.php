...
$_GET['emojiID']="1006";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="cloud emoji" description = "cloud emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="cloud emoji">☁️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about cloud emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="cloud emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>☁️</dd>
                                </dl>
...
<head>
    ...
    <title>cloud emoji ☁️ emoji ☁️☁️ copy and paste ☁️ emoji ☁️ emoji ☁️🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="cloud emoji ☁️☁️☁️☁️ Copy and paste & Search for any emojis ☁️☁️☁️(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="cloud emoji ☁️ emoji ☁️☁️ copy and paste ☁️ emoji ☁️ emoji ☁️🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"cloud emoji ☁️☁️☁️☁️ Copy and paste & Search for any emojis ☁️☁️☁️(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
