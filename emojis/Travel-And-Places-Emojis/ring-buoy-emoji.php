...
$_GET['emojiID']="931";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="ring buoy emoji" description = "ring buoy emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="ring buoy emoji">🛟</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about ring buoy emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="ring buoy emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🛟</dd>
                                </dl>
...
<head>
    ...
    <title>ring buoy emoji 🛟 emoji 🛟🛟 copy and paste 🛟 emoji 🛟 emoji 🛟🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="ring buoy emoji 🛟🛟🛟🛟 Copy and paste & Search for any emojis 🛟🛟🛟(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="ring buoy emoji 🛟 emoji 🛟🛟 copy and paste 🛟 emoji 🛟 emoji 🛟🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"ring buoy emoji 🛟🛟🛟🛟 Copy and paste & Search for any emojis 🛟🛟🛟(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
