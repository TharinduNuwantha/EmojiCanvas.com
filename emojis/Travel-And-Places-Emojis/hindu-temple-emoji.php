...
$_GET['emojiID']="859";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="hindu temple emoji" description = "hindu temple emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="hindu temple emoji">🛕</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about hindu temple emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="hindu temple emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🛕</dd>
                                </dl>
...
<head>
    ...
    <title>hindu temple emoji 🛕 emoji 🛕🛕 copy and paste 🛕 emoji 🛕 emoji 🛕🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="hindu temple emoji 🛕🛕🛕🛕 Copy and paste & Search for any emojis 🛕🛕🛕(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="hindu temple emoji 🛕 emoji 🛕🛕 copy and paste 🛕 emoji 🛕 emoji 🛕🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"hindu temple emoji 🛕🛕🛕🛕 Copy and paste & Search for any emojis 🛕🛕🛕(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
