...
$_GET['emojiID']="955";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="hourglass not done emoji" description = "hourglass not done emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="hourglass not done emoji">⏳</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about hourglass not done emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="hourglass not done emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>⏳</dd>
                                </dl>
...
<head>
    ...
    <title>hourglass not done emoji ⏳ emoji ⏳⏳ copy and paste ⏳ emoji ⏳ emoji ⏳🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="hourglass not done emoji ⏳⏳⏳⏳ Copy and paste & Search for any emojis ⏳⏳⏳(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="hourglass not done emoji ⏳ emoji ⏳⏳ copy and paste ⏳ emoji ⏳ emoji ⏳🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"hourglass not done emoji ⏳⏳⏳⏳ Copy and paste & Search for any emojis ⏳⏳⏳(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
