...
$_GET['emojiID']="989";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="full moon emoji" description = "full moon emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="full moon emoji">🌕</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about full moon emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="full moon emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🌕</dd>
                                </dl>
...
<head>
    ...
    <title>full moon emoji 🌕 emoji 🌕🌕 copy and paste 🌕 emoji 🌕 emoji 🌕🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="full moon emoji 🌕🌕🌕🌕 Copy and paste & Search for any emojis 🌕🌕🌕(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="full moon emoji 🌕 emoji 🌕🌕 copy and paste 🌕 emoji 🌕 emoji 🌕🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"full moon emoji 🌕🌕🌕🌕 Copy and paste & Search for any emojis 🌕🌕🌕(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
