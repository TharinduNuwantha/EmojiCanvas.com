...
$_GET['emojiID']="879";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="circus tent emoji" description = "circus tent emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="circus tent emoji">🎪</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about circus tent emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="circus tent emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎪</dd>
                                </dl>
...
<head>
    ...
    <title>circus tent emoji 🎪 emoji 🎪🎪 copy and paste 🎪 emoji 🎪 emoji 🎪🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="circus tent emoji 🎪🎪🎪🎪 Copy and paste & Search for any emojis 🎪🎪🎪(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="circus tent emoji 🎪 emoji 🎪🎪 copy and paste 🎪 emoji 🎪 emoji 🎪🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"circus tent emoji 🎪🎪🎪🎪 Copy and paste & Search for any emojis 🎪🎪🎪(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
