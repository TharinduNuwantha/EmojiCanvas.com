...
$_GET['emojiID']="996";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="last quarter moon face emoji" description = "last quarter moon face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="last quarter moon face emoji">🌜</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about last quarter moon face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="last quarter moon face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🌜</dd>
                                </dl>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>last_quarter_moon_with_face</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>last quarter moon face emoji 🌜 emoji 🌜🌜 copy and paste 🌜 emoji 🌜 emoji 🌜🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="last quarter moon face emoji 🌜🌜🌜🌜 Copy and paste & Search for any emojis 🌜🌜🌜(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="last quarter moon face emoji 🌜 emoji 🌜🌜 copy and paste 🌜 emoji 🌜 emoji 🌜🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"last quarter moon face emoji 🌜🌜🌜🌜 Copy and paste & Search for any emojis 🌜🌜🌜(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
