...
$_GET['emojiID']="926";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="horizontal traffic light emoji" description = "horizontal traffic light emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="horizontal traffic light emoji">🚥</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about horizontal traffic light emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="horizontal traffic light emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🚥</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>horizontal traffic light</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Travel & Places</dd>
...
<head>
    ...
    <title>horizontal traffic light emoji 🚥 emoji 🚥🚥 copy and paste 🚥 emoji 🚥 emoji 🚥🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="horizontal traffic light emoji 🚥🚥🚥🚥 Copy and paste & Search for any emojis 🚥🚥🚥(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="horizontal traffic light emoji 🚥 emoji 🚥🚥 copy and paste 🚥 emoji 🚥 emoji 🚥🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"horizontal traffic light emoji 🚥🚥🚥🚥 Copy and paste & Search for any emojis 🚥🚥🚥(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
