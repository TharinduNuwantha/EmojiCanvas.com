...
$_GET['emojiID']="942";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="airplane arrival emoji" description = "airplane arrival emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="airplane arrival emoji">🛬</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about airplane arrival emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="airplane arrival emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🛬</dd>
                                </dl>
...
<head>
    ...
    <title>airplane arrival emoji 🛬 emoji 🛬🛬 copy and paste 🛬 emoji 🛬 emoji 🛬🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="airplane arrival emoji 🛬🛬🛬🛬 Copy and paste & Search for any emojis 🛬🛬🛬(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="airplane arrival emoji 🛬 emoji 🛬🛬 copy and paste 🛬 emoji 🛬 emoji 🛬🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"airplane arrival emoji 🛬🛬🛬🛬 Copy and paste & Search for any emojis 🛬🛬🛬(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
