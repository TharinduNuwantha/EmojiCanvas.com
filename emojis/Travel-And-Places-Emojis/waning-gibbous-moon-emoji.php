...
$_GET['emojiID']="990";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="waning gibbous moon emoji" description = "waning gibbous moon emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="waning gibbous moon emoji">🌖</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about waning gibbous moon emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="waning gibbous moon emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🌖</dd>
                                </dl>
...
<head>
    ...
    <title>waning gibbous moon emoji 🌖 emoji 🌖🌖 copy and paste 🌖 emoji 🌖 emoji 🌖🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="waning gibbous moon emoji 🌖🌖🌖🌖 Copy and paste & Search for any emojis 🌖🌖🌖(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="waning gibbous moon emoji 🌖 emoji 🌖🌖 copy and paste 🌖 emoji 🌖 emoji 🌖🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"waning gibbous moon emoji 🌖🌖🌖🌖 Copy and paste & Search for any emojis 🌖🌖🌖(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
