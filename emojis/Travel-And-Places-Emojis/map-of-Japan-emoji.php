...
$_GET['emojiID']="819";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="map of Japan emoji" description = "map of Japan emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="map of Japan emoji">🗾</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about map of Japan emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="map of Japan emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🗾</dd>
                                </dl>
...
<head>
    ...
    <title>map of Japan emoji 🗾 emoji 🗾🗾 copy and paste 🗾 emoji 🗾 emoji 🗾🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="map of Japan emoji 🗾🗾🗾🗾 Copy and paste & Search for any emojis 🗾🗾🗾(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="map of Japan emoji 🗾 emoji 🗾🗾 copy and paste 🗾 emoji 🗾 emoji 🗾🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"map of Japan emoji 🗾🗾🗾🗾 Copy and paste & Search for any emojis 🗾🗾🗾(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
