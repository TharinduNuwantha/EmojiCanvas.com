...
$_GET['emojiID']="833";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="brick emoji" description = "brick emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="brick emoji">🧱</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about brick emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="brick emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🧱</dd>
                                </dl>
...
<head>
    ...
    <title>brick emoji 🧱 emoji 🧱🧱 copy and paste 🧱 emoji 🧱 emoji 🧱🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="brick emoji 🧱🧱🧱🧱 Copy and paste & Search for any emojis 🧱🧱🧱(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="brick emoji 🧱 emoji 🧱🧱 copy and paste 🧱 emoji 🧱 emoji 🧱🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"brick emoji 🧱🧱🧱🧱 Copy and paste & Search for any emojis 🧱🧱🧱(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
