...
$_GET['emojiID']="1012";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="cloud with rain emoji" description = "cloud with rain emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="cloud with rain emoji">🌧️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about cloud with rain emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="cloud with rain emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🌧️</dd>
                                </dl>
...
<head>
    ...
    <title>cloud with rain emoji 🌧️ emoji 🌧️🌧️ copy and paste 🌧️ emoji 🌧️ emoji 🌧️🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="cloud with rain emoji 🌧️🌧️🌧️🌧️ Copy and paste & Search for any emojis 🌧️🌧️🌧️(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="cloud with rain emoji 🌧️ emoji 🌧️🌧️ copy and paste 🌧️ emoji 🌧️ emoji 🌧️🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"cloud with rain emoji 🌧️🌧️🌧️🌧️ Copy and paste & Search for any emojis 🌧️🌧️🌧️(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
