...
$_GET['emojiID']="868";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="sunrise over mountains emoji" description = "sunrise over mountains emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="sunrise over mountains emoji">🌄</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about sunrise over mountains emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="sunrise over mountains emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🌄</dd>
                                </dl>
...
<head>
    ...
    <title>sunrise over mountains emoji 🌄 emoji 🌄🌄 copy and paste 🌄 emoji 🌄 emoji 🌄🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="sunrise over mountains emoji 🌄🌄🌄🌄 Copy and paste & Search for any emojis 🌄🌄🌄(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="sunrise over mountains emoji 🌄 emoji 🌄🌄 copy and paste 🌄 emoji 🌄 emoji 🌄🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"sunrise over mountains emoji 🌄🌄🌄🌄 Copy and paste & Search for any emojis 🌄🌄🌄(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
