...
$_GET['emojiID']="951";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flying saucer emoji" description = "flying saucer emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flying saucer emoji">🛸</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flying saucer emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flying saucer emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🛸</dd>
                                </dl>
...
<head>
    ...
    <title>flying saucer emoji 🛸 emoji 🛸🛸 copy and paste 🛸 emoji 🛸 emoji 🛸🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flying saucer emoji 🛸🛸🛸🛸 Copy and paste & Search for any emojis 🛸🛸🛸(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flying saucer emoji 🛸 emoji 🛸🛸 copy and paste 🛸 emoji 🛸 emoji 🛸🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"flying saucer emoji 🛸🛸🛸🛸 Copy and paste & Search for any emojis 🛸🛸🛸(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
