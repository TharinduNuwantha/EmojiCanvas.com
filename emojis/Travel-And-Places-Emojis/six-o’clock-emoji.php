...
$_GET['emojiID']="973";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="six o’clock emoji" description = "six o’clock emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="six o’clock emoji">🕕</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about six o’clock emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="six o’clock emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🕕</dd>
                                </dl>
...
<head>
    ...
    <title>six o’clock emoji 🕕 emoji 🕕🕕 copy and paste 🕕 emoji 🕕 emoji 🕕🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="six o’clock emoji 🕕🕕🕕🕕 Copy and paste & Search for any emojis 🕕🕕🕕(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="six o’clock emoji 🕕 emoji 🕕🕕 copy and paste 🕕 emoji 🕕 emoji 🕕🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"six o’clock emoji 🕕🕕🕕🕕 Copy and paste & Search for any emojis 🕕🕕🕕(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
