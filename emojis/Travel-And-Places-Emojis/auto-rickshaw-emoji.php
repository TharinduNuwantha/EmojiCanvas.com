...
$_GET['emojiID']="914";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="auto rickshaw emoji" description = "auto rickshaw emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="auto rickshaw emoji">🛺</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about auto rickshaw emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="auto rickshaw emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🛺</dd>
                                </dl>
...
<head>
    ...
    <title>auto rickshaw emoji 🛺 emoji 🛺🛺 copy and paste 🛺 emoji 🛺 emoji 🛺🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="auto rickshaw emoji 🛺🛺🛺🛺 Copy and paste & Search for any emojis 🛺🛺🛺(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="auto rickshaw emoji 🛺 emoji 🛺🛺 copy and paste 🛺 emoji 🛺 emoji 🛺🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"auto rickshaw emoji 🛺🛺🛺🛺 Copy and paste & Search for any emojis 🛺🛺🛺(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
