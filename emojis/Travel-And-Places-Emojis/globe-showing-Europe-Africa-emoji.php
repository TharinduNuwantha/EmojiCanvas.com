...
$_GET['emojiID']="814";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="globe showing Europe-Africa emoji" description = "globe showing Europe-Africa emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="globe showing Europe-Africa emoji">🌍</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about globe showing Europe-Africa emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="globe showing Europe-Africa emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🌍</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>globe showing Europe-Africa</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Travel & Places</dd>
...
<head>
    ...
    <title>globe showing Europe-Africa emoji 🌍 emoji 🌍🌍 copy and paste 🌍 emoji 🌍 emoji 🌍🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="globe showing Europe-Africa emoji 🌍🌍🌍🌍 Copy and paste & Search for any emojis 🌍🌍🌍(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="globe showing Europe-Africa emoji 🌍 emoji 🌍🌍 copy and paste 🌍 emoji 🌍 emoji 🌍🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"globe showing Europe-Africa emoji 🌍🌍🌍🌍 Copy and paste & Search for any emojis 🌍🌍🌍(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
