...
$_GET['emojiID']="1008";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="cloud with lightning and rain emoji" description = "cloud with lightning and rain emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="cloud with lightning and rain emoji">⛈️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about cloud with lightning and rain emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="cloud with lightning and rain emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>⛈️</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>cloud with lightning and rain</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Travel & Places</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>cloud_with_lightning_and_rain</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>cloud with lightning and rain emoji ⛈️ emoji ⛈️⛈️ copy and paste ⛈️ emoji ⛈️ emoji ⛈️🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="cloud with lightning and rain emoji ⛈️⛈️⛈️⛈️ Copy and paste & Search for any emojis ⛈️⛈️⛈️(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="cloud with lightning and rain emoji ⛈️ emoji ⛈️⛈️ copy and paste ⛈️ emoji ⛈️ emoji ⛈️🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"cloud with lightning and rain emoji ⛈️⛈️⛈️⛈️ Copy and paste & Search for any emojis ⛈️⛈️⛈️(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
