...
$_GET['emojiID']="876";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="ferris wheel emoji" description = "ferris wheel emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="ferris wheel emoji">🎡</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about ferris wheel emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="ferris wheel emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎡</dd>
                                </dl>
...
<head>
    ...
    <title>ferris wheel emoji 🎡 emoji 🎡🎡 copy and paste 🎡 emoji 🎡 emoji 🎡🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="ferris wheel emoji 🎡🎡🎡🎡 Copy and paste & Search for any emojis 🎡🎡🎡(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="ferris wheel emoji 🎡 emoji 🎡🎡 copy and paste 🎡 emoji 🎡 emoji 🎡🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"ferris wheel emoji 🎡🎡🎡🎡 Copy and paste & Search for any emojis 🎡🎡🎡(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
