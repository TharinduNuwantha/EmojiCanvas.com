...
$_GET['emojiID']="923";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="fuel pump emoji" description = "fuel pump emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="fuel pump emoji">⛽</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about fuel pump emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="fuel pump emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>⛽</dd>
                                </dl>
...
<head>
    ...
    <title>fuel pump emoji ⛽ emoji ⛽⛽ copy and paste ⛽ emoji ⛽ emoji ⛽🌍 🌎 🌏 🌐 🗺️ 🗾 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="fuel pump emoji ⛽⛽⛽⛽ Copy and paste & Search for any emojis ⛽⛽⛽(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="fuel pump emoji ⛽ emoji ⛽⛽ copy and paste ⛽ emoji ⛽ emoji ⛽🌍 🌎 🌏 🌐 🗺️ 🗾 " />
    <meta property="og:description"fuel pump emoji ⛽⛽⛽⛽ Copy and paste & Search for any emojis ⛽⛽⛽(Travel & Places)🌍 🌎 🌏 🌐 🗺️ 🗾 🧭 🏔️ ⛰️ 🌋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
