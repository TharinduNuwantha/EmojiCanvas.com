...
$_GET['emojiID']="1786";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: South Georgia & South Sandwich Islands emoji" description = "flag: South Georgia & South Sandwich Islands emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: South Georgia & South Sandwich Islands emoji">🇬🇸</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: South Georgia & South Sandwich Islands emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: South Georgia & South Sandwich Islands emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇬🇸</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>flag: South Georgia & South Sandwich Islands</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Flags</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>south_georgia_south_sandwich_islands</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>flag: South Georgia & South Sandwich Islands emoji 🇬🇸 emoji 🇬🇸🇬🇸 copy and paste 🇬🇸 emoji 🇬🇸 emoji 🇬🇸🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: South Georgia & South Sandwich Islands emoji 🇬🇸🇬🇸🇬🇸🇬🇸 Copy and paste & Search for any emojis 🇬🇸🇬🇸🇬🇸(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: South Georgia & South Sandwich Islands emoji 🇬🇸 emoji 🇬🇸🇬🇸 copy and paste 🇬🇸 emoji 🇬🇸 emoji 🇬🇸🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: South Georgia & South Sandwich Islands emoji 🇬🇸🇬🇸🇬🇸🇬🇸 Copy and paste & Search for any emojis 🇬🇸🇬🇸🇬🇸(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
    <meta property="og:image" content="./img/main/ee.png" />
    <meta property="og:locale" content="en_US" />
</head>
<body>
<?php include('../MasterStyle/topBar.php');?>
