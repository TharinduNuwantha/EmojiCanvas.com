...
$_GET['emojiID']="1932";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: Uruguay emoji" description = "flag: Uruguay emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: Uruguay emoji">🇺🇾</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: Uruguay emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: Uruguay emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇺🇾</dd>
                                </dl>
...
<head>
    ...
    <title>flag: Uruguay emoji 🇺🇾 emoji 🇺🇾🇺🇾 copy and paste 🇺🇾 emoji 🇺🇾 emoji 🇺🇾🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: Uruguay emoji 🇺🇾🇺🇾🇺🇾🇺🇾 Copy and paste & Search for any emojis 🇺🇾🇺🇾🇺🇾(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: Uruguay emoji 🇺🇾 emoji 🇺🇾🇺🇾 copy and paste 🇺🇾 emoji 🇺🇾 emoji 🇺🇾🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: Uruguay emoji 🇺🇾🇺🇾🇺🇾🇺🇾 Copy and paste & Search for any emojis 🇺🇾🇺🇾🇺🇾(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
