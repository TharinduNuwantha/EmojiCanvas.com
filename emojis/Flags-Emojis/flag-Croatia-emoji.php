...
$_GET['emojiID']="1794";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: Croatia emoji" description = "flag: Croatia emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: Croatia emoji">🇭🇷</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: Croatia emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: Croatia emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇭🇷</dd>
                                </dl>
...
<head>
    ...
    <title>flag: Croatia emoji 🇭🇷 emoji 🇭🇷🇭🇷 copy and paste 🇭🇷 emoji 🇭🇷 emoji 🇭🇷🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: Croatia emoji 🇭🇷🇭🇷🇭🇷🇭🇷 Copy and paste & Search for any emojis 🇭🇷🇭🇷🇭🇷(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: Croatia emoji 🇭🇷 emoji 🇭🇷🇭🇷 copy and paste 🇭🇷 emoji 🇭🇷 emoji 🇭🇷🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: Croatia emoji 🇭🇷🇭🇷🇭🇷🇭🇷 Copy and paste & Search for any emojis 🇭🇷🇭🇷🇭🇷(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
