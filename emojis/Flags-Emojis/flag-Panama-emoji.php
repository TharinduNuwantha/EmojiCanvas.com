...
$_GET['emojiID']="1869";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: Panama emoji" description = "flag: Panama emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: Panama emoji">🇵🇦</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: Panama emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: Panama emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇵🇦</dd>
                                </dl>
...
<head>
    ...
    <title>flag: Panama emoji 🇵🇦 emoji 🇵🇦🇵🇦 copy and paste 🇵🇦 emoji 🇵🇦 emoji 🇵🇦🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: Panama emoji 🇵🇦🇵🇦🇵🇦🇵🇦 Copy and paste & Search for any emojis 🇵🇦🇵🇦🇵🇦(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: Panama emoji 🇵🇦 emoji 🇵🇦🇵🇦 copy and paste 🇵🇦 emoji 🇵🇦 emoji 🇵🇦🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: Panama emoji 🇵🇦🇵🇦🇵🇦🇵🇦 Copy and paste & Search for any emojis 🇵🇦🇵🇦🇵🇦(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
