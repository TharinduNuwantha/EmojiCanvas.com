...
$_GET['emojiID']="1881";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: Palau emoji" description = "flag: Palau emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: Palau emoji">🇵🇼</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: Palau emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: Palau emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇵🇼</dd>
                                </dl>
...
<head>
    ...
    <title>flag: Palau emoji 🇵🇼 emoji 🇵🇼🇵🇼 copy and paste 🇵🇼 emoji 🇵🇼 emoji 🇵🇼🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: Palau emoji 🇵🇼🇵🇼🇵🇼🇵🇼 Copy and paste & Search for any emojis 🇵🇼🇵🇼🇵🇼(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: Palau emoji 🇵🇼 emoji 🇵🇼🇵🇼 copy and paste 🇵🇼 emoji 🇵🇼 emoji 🇵🇼🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: Palau emoji 🇵🇼🇵🇼🇵🇼🇵🇼 Copy and paste & Search for any emojis 🇵🇼🇵🇼🇵🇼(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
