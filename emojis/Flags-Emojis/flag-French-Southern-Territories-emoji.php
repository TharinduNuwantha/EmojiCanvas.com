...
$_GET['emojiID']="1913";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: French Southern Territories emoji" description = "flag: French Southern Territories emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: French Southern Territories emoji">🇹🇫</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: French Southern Territories emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: French Southern Territories emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇹🇫</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>flag: French Southern Territories</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Flags</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>french_southern_territories</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>flag: French Southern Territories emoji 🇹🇫 emoji 🇹🇫🇹🇫 copy and paste 🇹🇫 emoji 🇹🇫 emoji 🇹🇫🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: French Southern Territories emoji 🇹🇫🇹🇫🇹🇫🇹🇫 Copy and paste & Search for any emojis 🇹🇫🇹🇫🇹🇫(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: French Southern Territories emoji 🇹🇫 emoji 🇹🇫🇹🇫 copy and paste 🇹🇫 emoji 🇹🇫 emoji 🇹🇫🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: French Southern Territories emoji 🇹🇫🇹🇫🇹🇫🇹🇫 Copy and paste & Search for any emojis 🇹🇫🇹🇫🇹🇫(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
