...
$_GET['emojiID']="1733";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: Central African Republic emoji" description = "flag: Central African Republic emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: Central African Republic emoji">🇨🇫</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: Central African Republic emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: Central African Republic emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇨🇫</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>flag: Central African Republic</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Flags</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>central_african_republic</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>flag: Central African Republic emoji 🇨🇫 emoji 🇨🇫🇨🇫 copy and paste 🇨🇫 emoji 🇨🇫 emoji 🇨🇫🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: Central African Republic emoji 🇨🇫🇨🇫🇨🇫🇨🇫 Copy and paste & Search for any emojis 🇨🇫🇨🇫🇨🇫(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: Central African Republic emoji 🇨🇫 emoji 🇨🇫🇨🇫 copy and paste 🇨🇫 emoji 🇨🇫 emoji 🇨🇫🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: Central African Republic emoji 🇨🇫🇨🇫🇨🇫🇨🇫 Copy and paste & Search for any emojis 🇨🇫🇨🇫🇨🇫(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
