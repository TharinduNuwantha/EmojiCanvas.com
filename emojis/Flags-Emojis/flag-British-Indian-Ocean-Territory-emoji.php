...
$_GET['emojiID']="1803";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: British Indian Ocean Territory emoji" description = "flag: British Indian Ocean Territory emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: British Indian Ocean Territory emoji">🇮🇴</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: British Indian Ocean Territory emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: British Indian Ocean Territory emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇮🇴</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>flag: British Indian Ocean Territory</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Flags</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>british_indian_ocean_territory</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>flag: British Indian Ocean Territory emoji 🇮🇴 emoji 🇮🇴🇮🇴 copy and paste 🇮🇴 emoji 🇮🇴 emoji 🇮🇴🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: British Indian Ocean Territory emoji 🇮🇴🇮🇴🇮🇴🇮🇴 Copy and paste & Search for any emojis 🇮🇴🇮🇴🇮🇴(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: British Indian Ocean Territory emoji 🇮🇴 emoji 🇮🇴🇮🇴 copy and paste 🇮🇴 emoji 🇮🇴 emoji 🇮🇴🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: British Indian Ocean Territory emoji 🇮🇴🇮🇴🇮🇴🇮🇴 Copy and paste & Search for any emojis 🇮🇴🇮🇴🇮🇴(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
