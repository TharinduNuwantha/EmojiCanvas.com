...
$_GET['emojiID']="1750";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: Germany emoji" description = "flag: Germany emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: Germany emoji">🇩🇪</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: Germany emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: Germany emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇩🇪</dd>
                                </dl>
...
<head>
    ...
    <title>flag: Germany emoji 🇩🇪 emoji 🇩🇪🇩🇪 copy and paste 🇩🇪 emoji 🇩🇪 emoji 🇩🇪🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: Germany emoji 🇩🇪🇩🇪🇩🇪🇩🇪 Copy and paste & Search for any emojis 🇩🇪🇩🇪🇩🇪(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: Germany emoji 🇩🇪 emoji 🇩🇪🇩🇪 copy and paste 🇩🇪 emoji 🇩🇪 emoji 🇩🇪🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: Germany emoji 🇩🇪🇩🇪🇩🇪🇩🇪 Copy and paste & Search for any emojis 🇩🇪🇩🇪🇩🇪(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
