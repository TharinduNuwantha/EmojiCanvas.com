...
$_GET['emojiID']="1717";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: Benin emoji" description = "flag: Benin emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: Benin emoji">🇧🇯</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: Benin emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: Benin emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇧🇯</dd>
                                </dl>
...
<head>
    ...
    <title>flag: Benin emoji 🇧🇯 emoji 🇧🇯🇧🇯 copy and paste 🇧🇯 emoji 🇧🇯 emoji 🇧🇯🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: Benin emoji 🇧🇯🇧🇯🇧🇯🇧🇯 Copy and paste & Search for any emojis 🇧🇯🇧🇯🇧🇯(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: Benin emoji 🇧🇯 emoji 🇧🇯🇧🇯 copy and paste 🇧🇯 emoji 🇧🇯 emoji 🇧🇯🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: Benin emoji 🇧🇯🇧🇯🇧🇯🇧🇯 Copy and paste & Search for any emojis 🇧🇯🇧🇯🇧🇯(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
