...
$_GET['emojiID']="1849";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: Montserrat emoji" description = "flag: Montserrat emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: Montserrat emoji">🇲🇸</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: Montserrat emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: Montserrat emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇲🇸</dd>
                                </dl>
...
<head>
    ...
    <title>flag: Montserrat emoji 🇲🇸 emoji 🇲🇸🇲🇸 copy and paste 🇲🇸 emoji 🇲🇸 emoji 🇲🇸🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: Montserrat emoji 🇲🇸🇲🇸🇲🇸🇲🇸 Copy and paste & Search for any emojis 🇲🇸🇲🇸🇲🇸(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: Montserrat emoji 🇲🇸 emoji 🇲🇸🇲🇸 copy and paste 🇲🇸 emoji 🇲🇸 emoji 🇲🇸🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: Montserrat emoji 🇲🇸🇲🇸🇲🇸🇲🇸 Copy and paste & Search for any emojis 🇲🇸🇲🇸🇲🇸(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
