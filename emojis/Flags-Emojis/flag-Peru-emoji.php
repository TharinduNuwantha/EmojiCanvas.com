...
$_GET['emojiID']="1870";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="flag: Peru emoji" description = "flag: Peru emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="flag: Peru emoji">🇵🇪</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about flag: Peru emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="flag: Peru emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🇵🇪</dd>
                                </dl>
...
<head>
    ...
    <title>flag: Peru emoji 🇵🇪 emoji 🇵🇪🇵🇪 copy and paste 🇵🇪 emoji 🇵🇪 emoji 🇵🇪🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="flag: Peru emoji 🇵🇪🇵🇪🇵🇪🇵🇪 Copy and paste & Search for any emojis 🇵🇪🇵🇪🇵🇪(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="flag: Peru emoji 🇵🇪 emoji 🇵🇪🇵🇪 copy and paste 🇵🇪 emoji 🇵🇪 emoji 🇵🇪🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 " />
    <meta property="og:description"flag: Peru emoji 🇵🇪🇵🇪🇵🇪🇵🇪 Copy and paste & Search for any emojis 🇵🇪🇵🇪🇵🇪(Flags)🏁 🚩 🎌 🏴 🏳️ 🏳️‍🌈 🏳️‍⚧️ 🏴‍☠️ 🇦🇨 🇦🇩 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
