...
$_GET['emojiID']="422";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="woman in manual wheelchair emoji" description = "woman in manual wheelchair emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="woman in manual wheelchair emoji">👩‍🦽</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about woman in manual wheelchair emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="woman in manual wheelchair emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👩‍🦽</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>woman in manual wheelchair</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>People & Body</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>woman_in_manual_wheelchair</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>woman in manual wheelchair emoji 👩‍🦽 emoji 👩‍🦽👩‍🦽 copy and paste 👩‍🦽 emoji 👩‍🦽 emoji 👩‍🦽👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="woman in manual wheelchair emoji 👩‍🦽👩‍🦽👩‍🦽👩‍🦽 Copy and paste & Search for any emojis 👩‍🦽👩‍🦽👩‍🦽(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="woman in manual wheelchair emoji 👩‍🦽 emoji 👩‍🦽👩‍🦽 copy and paste 👩‍🦽 emoji 👩‍🦽 emoji 👩‍🦽👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"woman in manual wheelchair emoji 👩‍🦽👩‍🦽👩‍🦽👩‍🦽 Copy and paste & Search for any emojis 👩‍🦽👩‍🦽👩‍🦽(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
