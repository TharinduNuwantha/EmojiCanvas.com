...
$_GET['emojiID']="211";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="mechanical arm emoji" description = "mechanical arm emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="mechanical arm emoji">🦾</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about mechanical arm emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="mechanical arm emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🦾</dd>
                                </dl>
...
<head>
    ...
    <title>mechanical arm emoji 🦾 emoji 🦾🦾 copy and paste 🦾 emoji 🦾 emoji 🦾👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="mechanical arm emoji 🦾🦾🦾🦾 Copy and paste & Search for any emojis 🦾🦾🦾(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="mechanical arm emoji 🦾 emoji 🦾🦾 copy and paste 🦾 emoji 🦾 emoji 🦾👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"mechanical arm emoji 🦾🦾🦾🦾 Copy and paste & Search for any emojis 🦾🦾🦾(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
