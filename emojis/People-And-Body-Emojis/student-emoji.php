...
$_GET['emojiID']="289";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="student emoji" description = "student emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="student emoji">🧑‍🎓</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about student emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="student emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🧑‍🎓</dd>
                                </dl>
...
<head>
    ...
    <title>student emoji 🧑‍🎓 emoji 🧑‍🎓🧑‍🎓 copy and paste 🧑‍🎓 emoji 🧑‍🎓 emoji 🧑‍🎓👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="student emoji 🧑‍🎓🧑‍🎓🧑‍🎓🧑‍🎓 Copy and paste & Search for any emojis 🧑‍🎓🧑‍🎓🧑‍🎓(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="student emoji 🧑‍🎓 emoji 🧑‍🎓🧑‍🎓 copy and paste 🧑‍🎓 emoji 🧑‍🎓 emoji 🧑‍🎓👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"student emoji 🧑‍🎓🧑‍🎓🧑‍🎓🧑‍🎓 Copy and paste & Search for any emojis 🧑‍🎓🧑‍🎓🧑‍🎓(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
