...
$_GET['emojiID']="169";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="hand with fingers splayed emoji" description = "hand with fingers splayed emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="hand with fingers splayed emoji">🖐️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about hand with fingers splayed emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="hand with fingers splayed emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🖐️</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>hand with fingers splayed</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>People & Body</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>raised_hand_with_fingers_splayed</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>hand with fingers splayed emoji 🖐️ emoji 🖐️🖐️ copy and paste 🖐️ emoji 🖐️ emoji 🖐️👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="hand with fingers splayed emoji 🖐️🖐️🖐️🖐️ Copy and paste & Search for any emojis 🖐️🖐️🖐️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="hand with fingers splayed emoji 🖐️ emoji 🖐️🖐️ copy and paste 🖐️ emoji 🖐️ emoji 🖐️👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"hand with fingers splayed emoji 🖐️🖐️🖐️🖐️ Copy and paste & Search for any emojis 🖐️🖐️🖐️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
