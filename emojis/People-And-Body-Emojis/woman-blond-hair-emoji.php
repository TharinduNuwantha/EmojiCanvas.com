...
$_GET['emojiID']="251";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="woman: blond hair emoji" description = "woman: blond hair emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="woman: blond hair emoji">👱‍♀️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about woman: blond hair emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="woman: blond hair emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👱‍♀️</dd>
                                </dl>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>blond_haired_woman,blonde_woman</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>woman: blond hair emoji 👱‍♀️ emoji 👱‍♀️👱‍♀️ copy and paste 👱‍♀️ emoji 👱‍♀️ emoji 👱‍♀️👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="woman: blond hair emoji 👱‍♀️👱‍♀️👱‍♀️👱‍♀️ Copy and paste & Search for any emojis 👱‍♀️👱‍♀️👱‍♀️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="woman: blond hair emoji 👱‍♀️ emoji 👱‍♀️👱‍♀️ copy and paste 👱‍♀️ emoji 👱‍♀️ emoji 👱‍♀️👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"woman: blond hair emoji 👱‍♀️👱‍♀️👱‍♀️👱‍♀️ Copy and paste & Search for any emojis 👱‍♀️👱‍♀️👱‍♀️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
