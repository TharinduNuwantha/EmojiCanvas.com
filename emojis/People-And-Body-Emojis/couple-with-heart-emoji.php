...
$_GET['emojiID']="494";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="couple with heart emoji" description = "couple with heart emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="couple with heart emoji">💑</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about couple with heart emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="couple with heart emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>💑</dd>
                                </dl>
...
<head>
    ...
    <title>couple with heart emoji 💑 emoji 💑💑 copy and paste 💑 emoji 💑 emoji 💑👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="couple with heart emoji 💑💑💑💑 Copy and paste & Search for any emojis 💑💑💑(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="couple with heart emoji 💑 emoji 💑💑 copy and paste 💑 emoji 💑 emoji 💑👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"couple with heart emoji 💑💑💑💑 Copy and paste & Search for any emojis 💑💑💑(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
