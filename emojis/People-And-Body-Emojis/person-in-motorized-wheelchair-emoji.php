...
$_GET['emojiID']="417";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="person in motorized wheelchair emoji" description = "person in motorized wheelchair emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="person in motorized wheelchair emoji">🧑‍🦼</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about person in motorized wheelchair emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="person in motorized wheelchair emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🧑‍🦼</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>person in motorized wheelchair</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>People & Body</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>person_in_motorized_wheelchair</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>person in motorized wheelchair emoji 🧑‍🦼 emoji 🧑‍🦼🧑‍🦼 copy and paste 🧑‍🦼 emoji 🧑‍🦼 emoji 🧑‍🦼👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="person in motorized wheelchair emoji 🧑‍🦼🧑‍🦼🧑‍🦼🧑‍🦼 Copy and paste & Search for any emojis 🧑‍🦼🧑‍🦼🧑‍🦼(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="person in motorized wheelchair emoji 🧑‍🦼 emoji 🧑‍🦼🧑‍🦼 copy and paste 🧑‍🦼 emoji 🧑‍🦼 emoji 🧑‍🦼👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"person in motorized wheelchair emoji 🧑‍🦼🧑‍🦼🧑‍🦼🧑‍🦼 Copy and paste & Search for any emojis 🧑‍🦼🧑‍🦼🧑‍🦼(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
