...
$_GET['emojiID']="391";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="man elf emoji" description = "man elf emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="man elf emoji">🧝‍♂️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about man elf emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="man elf emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🧝‍♂️</dd>
                                </dl>
...
<head>
    ...
    <title>man elf emoji 🧝‍♂️ emoji 🧝‍♂️🧝‍♂️ copy and paste 🧝‍♂️ emoji 🧝‍♂️ emoji 🧝‍♂️👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="man elf emoji 🧝‍♂️🧝‍♂️🧝‍♂️🧝‍♂️ Copy and paste & Search for any emojis 🧝‍♂️🧝‍♂️🧝‍♂️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="man elf emoji 🧝‍♂️ emoji 🧝‍♂️🧝‍♂️ copy and paste 🧝‍♂️ emoji 🧝‍♂️ emoji 🧝‍♂️👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"man elf emoji 🧝‍♂️🧝‍♂️🧝‍♂️🧝‍♂️ Copy and paste & Search for any emojis 🧝‍♂️🧝‍♂️🧝‍♂️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
