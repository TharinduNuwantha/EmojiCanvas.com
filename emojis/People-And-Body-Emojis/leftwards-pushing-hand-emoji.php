...
$_GET['emojiID']="176";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="leftwards pushing hand emoji" description = "leftwards pushing hand emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="leftwards pushing hand emoji">🫷</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about leftwards pushing hand emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="leftwards pushing hand emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🫷</dd>
                                </dl>
...
<head>
    ...
    <title>leftwards pushing hand emoji 🫷 emoji 🫷🫷 copy and paste 🫷 emoji 🫷 emoji 🫷👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="leftwards pushing hand emoji 🫷🫷🫷🫷 Copy and paste & Search for any emojis 🫷🫷🫷(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="leftwards pushing hand emoji 🫷 emoji 🫷🫷 copy and paste 🫷 emoji 🫷 emoji 🫷👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"leftwards pushing hand emoji 🫷🫷🫷🫷 Copy and paste & Search for any emojis 🫷🫷🫷(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
