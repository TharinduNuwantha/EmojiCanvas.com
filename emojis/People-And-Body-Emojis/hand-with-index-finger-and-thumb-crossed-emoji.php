...
$_GET['emojiID']="183";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="hand with index finger and thumb crossed emoji" description = "hand with index finger and thumb crossed emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="hand with index finger and thumb crossed emoji">🫰</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about hand with index finger and thumb crossed emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="hand with index finger and thumb crossed emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🫰</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>hand with index finger and thumb crossed</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>People & Body</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>hand_with_index_finger_and_thumb_crossed</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>hand with index finger and thumb crossed emoji 🫰 emoji 🫰🫰 copy and paste 🫰 emoji 🫰 emoji 🫰👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="hand with index finger and thumb crossed emoji 🫰🫰🫰🫰 Copy and paste & Search for any emojis 🫰🫰🫰(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="hand with index finger and thumb crossed emoji 🫰 emoji 🫰🫰 copy and paste 🫰 emoji 🫰 emoji 🫰👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"hand with index finger and thumb crossed emoji 🫰🫰🫰🫰 Copy and paste & Search for any emojis 🫰🫰🫰(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
