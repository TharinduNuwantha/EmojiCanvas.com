...
$_GET['emojiID']="472";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="person playing water polo emoji" description = "person playing water polo emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="person playing water polo emoji">🤽</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about person playing water polo emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="person playing water polo emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🤽</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>person playing water polo</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>People & Body</dd>
...
<head>
    ...
    <title>person playing water polo emoji 🤽 emoji 🤽🤽 copy and paste 🤽 emoji 🤽 emoji 🤽👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="person playing water polo emoji 🤽🤽🤽🤽 Copy and paste & Search for any emojis 🤽🤽🤽(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="person playing water polo emoji 🤽 emoji 🤽🤽 copy and paste 🤽 emoji 🤽 emoji 🤽👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"person playing water polo emoji 🤽🤽🤽🤽 Copy and paste & Search for any emojis 🤽🤽🤽(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
