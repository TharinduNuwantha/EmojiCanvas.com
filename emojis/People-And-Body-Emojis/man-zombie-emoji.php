...
$_GET['emojiID']="397";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="man zombie emoji" description = "man zombie emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="man zombie emoji">🧟‍♂️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about man zombie emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="man zombie emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🧟‍♂️</dd>
                                </dl>
...
<head>
    ...
    <title>man zombie emoji 🧟‍♂️ emoji 🧟‍♂️🧟‍♂️ copy and paste 🧟‍♂️ emoji 🧟‍♂️ emoji 🧟‍♂️👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="man zombie emoji 🧟‍♂️🧟‍♂️🧟‍♂️🧟‍♂️ Copy and paste & Search for any emojis 🧟‍♂️🧟‍♂️🧟‍♂️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="man zombie emoji 🧟‍♂️ emoji 🧟‍♂️🧟‍♂️ copy and paste 🧟‍♂️ emoji 🧟‍♂️ emoji 🧟‍♂️👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"man zombie emoji 🧟‍♂️🧟‍♂️🧟‍♂️🧟‍♂️ Copy and paste & Search for any emojis 🧟‍♂️🧟‍♂️🧟‍♂️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
