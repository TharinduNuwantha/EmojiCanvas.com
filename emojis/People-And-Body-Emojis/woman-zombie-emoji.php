...
$_GET['emojiID']="398";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="woman zombie emoji" description = "woman zombie emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="woman zombie emoji">🧟‍♀️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about woman zombie emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="woman zombie emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🧟‍♀️</dd>
                                </dl>
...
<head>
    ...
    <title>woman zombie emoji 🧟‍♀️ emoji 🧟‍♀️🧟‍♀️ copy and paste 🧟‍♀️ emoji 🧟‍♀️ emoji 🧟‍♀️👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="woman zombie emoji 🧟‍♀️🧟‍♀️🧟‍♀️🧟‍♀️ Copy and paste & Search for any emojis 🧟‍♀️🧟‍♀️🧟‍♀️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="woman zombie emoji 🧟‍♀️ emoji 🧟‍♀️🧟‍♀️ copy and paste 🧟‍♀️ emoji 🧟‍♀️ emoji 🧟‍♀️👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"woman zombie emoji 🧟‍♀️🧟‍♀️🧟‍♀️🧟‍♀️ Copy and paste & Search for any emojis 🧟‍♀️🧟‍♀️🧟‍♀️(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
