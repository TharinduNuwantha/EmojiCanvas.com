...
$_GET['emojiID']="184";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="love-you gesture emoji" description = "love-you gesture emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="love-you gesture emoji">🤟</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about love-you gesture emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="love-you gesture emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🤟</dd>
                                </dl>
...
<head>
    ...
    <title>love-you gesture emoji 🤟 emoji 🤟🤟 copy and paste 🤟 emoji 🤟 emoji 🤟👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="love-you gesture emoji 🤟🤟🤟🤟 Copy and paste & Search for any emojis 🤟🤟🤟(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="love-you gesture emoji 🤟 emoji 🤟🤟 copy and paste 🤟 emoji 🤟 emoji 🤟👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"love-you gesture emoji 🤟🤟🤟🤟 Copy and paste & Search for any emojis 🤟🤟🤟(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
