...
$_GET['emojiID']="502";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="family: man, woman, boy, boy emoji" description = "family: man, woman, boy, boy emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="family: man, woman, boy, boy emoji">👨‍👩‍👦‍👦</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about family: man, woman, boy, boy emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="family: man, woman, boy, boy emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👨‍👩‍👦‍👦</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>family: man, woman, boy, boy</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>People & Body</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>family_man_woman_boy_boy</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>family: man, woman, boy, boy emoji 👨‍👩‍👦‍👦 emoji 👨‍👩‍👦‍👦👨‍👩‍👦‍👦 copy and paste 👨‍👩‍👦‍👦 emoji 👨‍👩‍👦‍👦 emoji 👨‍👩‍👦‍👦👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="family: man, woman, boy, boy emoji 👨‍👩‍👦‍👦👨‍👩‍👦‍👦👨‍👩‍👦‍👦👨‍👩‍👦‍👦 Copy and paste & Search for any emojis 👨‍👩‍👦‍👦👨‍👩‍👦‍👦👨‍👩‍👦‍👦(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="family: man, woman, boy, boy emoji 👨‍👩‍👦‍👦 emoji 👨‍👩‍👦‍👦👨‍👩‍👦‍👦 copy and paste 👨‍👩‍👦‍👦 emoji 👨‍👩‍👦‍👦 emoji 👨‍👩‍👦‍👦👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"family: man, woman, boy, boy emoji 👨‍👩‍👦‍👦👨‍👩‍👦‍👦👨‍👩‍👦‍👦👨‍👩‍👦‍👦 Copy and paste & Search for any emojis 👨‍👩‍👦‍👦👨‍👩‍👦‍👦👨‍👩‍👦‍👦(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
