...
$_GET['emojiID']="259";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="person pouting emoji" description = "person pouting emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="person pouting emoji">🙎</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about person pouting emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="person pouting emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🙎</dd>
                                </dl>
...
<head>
    ...
    <title>person pouting emoji 🙎 emoji 🙎🙎 copy and paste 🙎 emoji 🙎 emoji 🙎👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="person pouting emoji 🙎🙎🙎🙎 Copy and paste & Search for any emojis 🙎🙎🙎(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="person pouting emoji 🙎 emoji 🙎🙎 copy and paste 🙎 emoji 🙎 emoji 🙎👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"person pouting emoji 🙎🙎🙎🙎 Copy and paste & Search for any emojis 🙎🙎🙎(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
