...
$_GET['emojiID']="189";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="backhand index pointing up emoji" description = "backhand index pointing up emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="backhand index pointing up emoji">👆</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about backhand index pointing up emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="backhand index pointing up emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👆</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>backhand index pointing up</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>People & Body</dd>
...
<head>
    ...
    <title>backhand index pointing up emoji 👆 emoji 👆👆 copy and paste 👆 emoji 👆 emoji 👆👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="backhand index pointing up emoji 👆👆👆👆 Copy and paste & Search for any emojis 👆👆👆(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="backhand index pointing up emoji 👆 emoji 👆👆 copy and paste 👆 emoji 👆 emoji 👆👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"backhand index pointing up emoji 👆👆👆👆 Copy and paste & Search for any emojis 👆👆👆(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
