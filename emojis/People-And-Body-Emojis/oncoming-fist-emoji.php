...
$_GET['emojiID']="197";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="oncoming fist emoji" description = "oncoming fist emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="oncoming fist emoji">👊</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about oncoming fist emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="oncoming fist emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👊</dd>
                                </dl>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>fist_oncoming,facepunch,punch</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>oncoming fist emoji 👊 emoji 👊👊 copy and paste 👊 emoji 👊 emoji 👊👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="oncoming fist emoji 👊👊👊👊 Copy and paste & Search for any emojis 👊👊👊(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="oncoming fist emoji 👊 emoji 👊👊 copy and paste 👊 emoji 👊 emoji 👊👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"oncoming fist emoji 👊👊👊👊 Copy and paste & Search for any emojis 👊👊👊(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
