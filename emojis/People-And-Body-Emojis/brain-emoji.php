...
$_GET['emojiID']="218";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="brain emoji" description = "brain emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="brain emoji">🧠</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about brain emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="brain emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🧠</dd>
                                </dl>
...
<head>
    ...
    <title>brain emoji 🧠 emoji 🧠🧠 copy and paste 🧠 emoji 🧠 emoji 🧠👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="brain emoji 🧠🧠🧠🧠 Copy and paste & Search for any emojis 🧠🧠🧠(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="brain emoji 🧠 emoji 🧠🧠 copy and paste 🧠 emoji 🧠 emoji 🧠👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"brain emoji 🧠🧠🧠🧠 Copy and paste & Search for any emojis 🧠🧠🧠(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
