...
$_GET['emojiID']="320";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="man singer emoji" description = "man singer emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="man singer emoji">👨‍🎤</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about man singer emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="man singer emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👨‍🎤</dd>
                                </dl>
...
<head>
    ...
    <title>man singer emoji 👨‍🎤 emoji 👨‍🎤👨‍🎤 copy and paste 👨‍🎤 emoji 👨‍🎤 emoji 👨‍🎤👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="man singer emoji 👨‍🎤👨‍🎤👨‍🎤👨‍🎤 Copy and paste & Search for any emojis 👨‍🎤👨‍🎤👨‍🎤(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="man singer emoji 👨‍🎤 emoji 👨‍🎤👨‍🎤 copy and paste 👨‍🎤 emoji 👨‍🎤 emoji 👨‍🎤👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"man singer emoji 👨‍🎤👨‍🎤👨‍🎤👨‍🎤 Copy and paste & Search for any emojis 👨‍🎤👨‍🎤👨‍🎤(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
