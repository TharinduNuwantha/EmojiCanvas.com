...
$_GET['emojiID']="323";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="man artist emoji" description = "man artist emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="man artist emoji">👨‍🎨</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about man artist emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="man artist emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👨‍🎨</dd>
                                </dl>
...
<head>
    ...
    <title>man artist emoji 👨‍🎨 emoji 👨‍🎨👨‍🎨 copy and paste 👨‍🎨 emoji 👨‍🎨 emoji 👨‍🎨👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="man artist emoji 👨‍🎨👨‍🎨👨‍🎨👨‍🎨 Copy and paste & Search for any emojis 👨‍🎨👨‍🎨👨‍🎨(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="man artist emoji 👨‍🎨 emoji 👨‍🎨👨‍🎨 copy and paste 👨‍🎨 emoji 👨‍🎨 emoji 👨‍🎨👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"man artist emoji 👨‍🎨👨‍🎨👨‍🎨👨‍🎨 Copy and paste & Search for any emojis 👨‍🎨👨‍🎨👨‍🎨(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
