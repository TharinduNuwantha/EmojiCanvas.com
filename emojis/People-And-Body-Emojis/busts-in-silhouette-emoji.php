...
$_GET['emojiID']="526";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="busts in silhouette emoji" description = "busts in silhouette emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="busts in silhouette emoji">👥</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about busts in silhouette emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="busts in silhouette emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👥</dd>
                                </dl>
...
<head>
    ...
    <title>busts in silhouette emoji 👥 emoji 👥👥 copy and paste 👥 emoji 👥 emoji 👥👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="busts in silhouette emoji 👥👥👥👥 Copy and paste & Search for any emojis 👥👥👥(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="busts in silhouette emoji 👥 emoji 👥👥 copy and paste 👥 emoji 👥 emoji 👥👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"busts in silhouette emoji 👥👥👥👥 Copy and paste & Search for any emojis 👥👥👥(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
