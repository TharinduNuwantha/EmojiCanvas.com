...
$_GET['emojiID']="305";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="man mechanic emoji" description = "man mechanic emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="man mechanic emoji">👨‍🔧</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about man mechanic emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="man mechanic emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👨‍🔧</dd>
                                </dl>
...
<head>
    ...
    <title>man mechanic emoji 👨‍🔧 emoji 👨‍🔧👨‍🔧 copy and paste 👨‍🔧 emoji 👨‍🔧 emoji 👨‍🔧👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="man mechanic emoji 👨‍🔧👨‍🔧👨‍🔧👨‍🔧 Copy and paste & Search for any emojis 👨‍🔧👨‍🔧👨‍🔧(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="man mechanic emoji 👨‍🔧 emoji 👨‍🔧👨‍🔧 copy and paste 👨‍🔧 emoji 👨‍🔧 emoji 👨‍🔧👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"man mechanic emoji 👨‍🔧👨‍🔧👨‍🔧👨‍🔧 Copy and paste & Search for any emojis 👨‍🔧👨‍🔧👨‍🔧(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
