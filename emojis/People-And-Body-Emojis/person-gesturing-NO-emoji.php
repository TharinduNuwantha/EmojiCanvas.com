...
$_GET['emojiID']="262";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="person gesturing NO emoji" description = "person gesturing NO emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="person gesturing NO emoji">🙅</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about person gesturing NO emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="person gesturing NO emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🙅</dd>
                                </dl>
...
<head>
    ...
    <title>person gesturing NO emoji 🙅 emoji 🙅🙅 copy and paste 🙅 emoji 🙅 emoji 🙅👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="person gesturing NO emoji 🙅🙅🙅🙅 Copy and paste & Search for any emojis 🙅🙅🙅(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="person gesturing NO emoji 🙅 emoji 🙅🙅 copy and paste 🙅 emoji 🙅 emoji 🙅👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"person gesturing NO emoji 🙅🙅🙅🙅 Copy and paste & Search for any emojis 🙅🙅🙅(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
