...
$_GET['emojiID']="415";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="person with white cane emoji" description = "person with white cane emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="person with white cane emoji">🧑‍🦯</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about person with white cane emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="person with white cane emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🧑‍🦯</dd>
                                </dl>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>person_with_probing_cane</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>person with white cane emoji 🧑‍🦯 emoji 🧑‍🦯🧑‍🦯 copy and paste 🧑‍🦯 emoji 🧑‍🦯 emoji 🧑‍🦯👋 🤚 🖐️ ✋ 🖖 🫱 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="person with white cane emoji 🧑‍🦯🧑‍🦯🧑‍🦯🧑‍🦯 Copy and paste & Search for any emojis 🧑‍🦯🧑‍🦯🧑‍🦯(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="person with white cane emoji 🧑‍🦯 emoji 🧑‍🦯🧑‍🦯 copy and paste 🧑‍🦯 emoji 🧑‍🦯 emoji 🧑‍🦯👋 🤚 🖐️ ✋ 🖖 🫱 " />
    <meta property="og:description"person with white cane emoji 🧑‍🦯🧑‍🦯🧑‍🦯🧑‍🦯 Copy and paste & Search for any emojis 🧑‍🦯🧑‍🦯🧑‍🦯(People & Body)👋 🤚 🖐️ ✋ 🖖 🫱 🫲 🫳 🫴 🫷 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
