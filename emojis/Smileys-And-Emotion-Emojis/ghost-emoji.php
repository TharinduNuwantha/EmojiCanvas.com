...
$_GET['emojiID']="112";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="ghost emoji" description = "ghost emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="ghost emoji">👻</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about ghost emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="ghost emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👻</dd>
                                </dl>
...
<head>
    ...
    <title>ghost emoji 👻 emoji 👻👻 copy and paste 👻 emoji 👻 emoji 👻😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="ghost emoji 👻👻👻👻 Copy and paste & Search for any emojis 👻👻👻(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="ghost emoji 👻 emoji 👻👻 copy and paste 👻 emoji 👻 emoji 👻😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"ghost emoji 👻👻👻👻 Copy and paste & Search for any emojis 👻👻👻(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
