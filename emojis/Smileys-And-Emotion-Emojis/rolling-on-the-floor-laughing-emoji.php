...
$_GET['emojiID']="7";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="rolling on the floor laughing emoji" description = "rolling on the floor laughing emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="rolling on the floor laughing emoji">🤣</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about rolling on the floor laughing emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="rolling on the floor laughing emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🤣</dd>
                                </dl>
...
<head>
    ...
    <title>rolling on the floor laughing emoji 🤣 emoji 🤣🤣 copy and paste 🤣 emoji 🤣 emoji 🤣😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="rolling on the floor laughing emoji 🤣🤣🤣🤣 Copy and paste & Search for any emojis 🤣🤣🤣(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="rolling on the floor laughing emoji 🤣 emoji 🤣🤣 copy and paste 🤣 emoji 🤣 emoji 🤣😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"rolling on the floor laughing emoji 🤣🤣🤣🤣 Copy and paste & Search for any emojis 🤣🤣🤣(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
