...
$_GET['emojiID']="63";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="cold face emoji" description = "cold face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="cold face emoji">🥶</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about cold face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="cold face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🥶</dd>
                                </dl>
...
<head>
    ...
    <title>cold face emoji 🥶 emoji 🥶🥶 copy and paste 🥶 emoji 🥶 emoji 🥶😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="cold face emoji 🥶🥶🥶🥶 Copy and paste & Search for any emojis 🥶🥶🥶(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="cold face emoji 🥶 emoji 🥶🥶 copy and paste 🥶 emoji 🥶 emoji 🥶😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"cold face emoji 🥶🥶🥶🥶 Copy and paste & Search for any emojis 🥶🥶🥶(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
