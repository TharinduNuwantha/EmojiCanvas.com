...
$_GET['emojiID']="123";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="crying cat emoji" description = "crying cat emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="crying cat emoji">😿</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about crying cat emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="crying cat emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>😿</dd>
                                </dl>
...
<head>
    ...
    <title>crying cat emoji 😿 emoji 😿😿 copy and paste 😿 emoji 😿 emoji 😿😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="crying cat emoji 😿😿😿😿 Copy and paste & Search for any emojis 😿😿😿(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="crying cat emoji 😿 emoji 😿😿 copy and paste 😿 emoji 😿 emoji 😿😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"crying cat emoji 😿😿😿😿 Copy and paste & Search for any emojis 😿😿😿(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
