...
$_GET['emojiID']="60";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="face vomiting emoji" description = "face vomiting emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="face vomiting emoji">🤮</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about face vomiting emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="face vomiting emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🤮</dd>
                                </dl>
...
<head>
    ...
    <title>face vomiting emoji 🤮 emoji 🤮🤮 copy and paste 🤮 emoji 🤮 emoji 🤮😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="face vomiting emoji 🤮🤮🤮🤮 Copy and paste & Search for any emojis 🤮🤮🤮(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="face vomiting emoji 🤮 emoji 🤮🤮 copy and paste 🤮 emoji 🤮 emoji 🤮😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"face vomiting emoji 🤮🤮🤮🤮 Copy and paste & Search for any emojis 🤮🤮🤮(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
