...
$_GET['emojiID']="10";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="upside-down face emoji" description = "upside-down face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="upside-down face emoji">🙃</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about upside-down face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="upside-down face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🙃</dd>
                                </dl>
...
<head>
    ...
    <title>upside-down face emoji 🙃 emoji 🙃🙃 copy and paste 🙃 emoji 🙃 emoji 🙃😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="upside-down face emoji 🙃🙃🙃🙃 Copy and paste & Search for any emojis 🙃🙃🙃(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="upside-down face emoji 🙃 emoji 🙃🙃 copy and paste 🙃 emoji 🙃 emoji 🙃😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"upside-down face emoji 🙃🙃🙃🙃 Copy and paste & Search for any emojis 🙃🙃🙃(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
