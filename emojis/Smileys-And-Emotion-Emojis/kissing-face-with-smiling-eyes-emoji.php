...
$_GET['emojiID']="22";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="kissing face with smiling eyes emoji" description = "kissing face with smiling eyes emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="kissing face with smiling eyes emoji">😙</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about kissing face with smiling eyes emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="kissing face with smiling eyes emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>😙</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>kissing face with smiling eyes</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
...
<head>
    ...
    <title>kissing face with smiling eyes emoji 😙 emoji 😙😙 copy and paste 😙 emoji 😙 emoji 😙😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="kissing face with smiling eyes emoji 😙😙😙😙 Copy and paste & Search for any emojis 😙😙😙(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="kissing face with smiling eyes emoji 😙 emoji 😙😙 copy and paste 😙 emoji 😙 emoji 😙😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"kissing face with smiling eyes emoji 😙😙😙😙 Copy and paste & Search for any emojis 😙😙😙(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
