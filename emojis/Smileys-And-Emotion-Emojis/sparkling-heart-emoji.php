...
$_GET['emojiID']="131";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="sparkling heart emoji" description = "sparkling heart emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="sparkling heart emoji">💖</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about sparkling heart emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="sparkling heart emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>💖</dd>
                                </dl>
...
<head>
    ...
    <title>sparkling heart emoji 💖 emoji 💖💖 copy and paste 💖 emoji 💖 emoji 💖😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="sparkling heart emoji 💖💖💖💖 Copy and paste & Search for any emojis 💖💖💖(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="sparkling heart emoji 💖 emoji 💖💖 copy and paste 💖 emoji 💖 emoji 💖😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"sparkling heart emoji 💖💖💖💖 Copy and paste & Search for any emojis 💖💖💖(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
