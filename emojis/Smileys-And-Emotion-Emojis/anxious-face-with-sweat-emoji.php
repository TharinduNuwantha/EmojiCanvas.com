...
$_GET['emojiID']="88";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="anxious face with sweat emoji" description = "anxious face with sweat emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="anxious face with sweat emoji">😰</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about anxious face with sweat emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="anxious face with sweat emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>😰</dd>
                                </dl>
...
<head>
    ...
    <title>anxious face with sweat emoji 😰 emoji 😰😰 copy and paste 😰 emoji 😰 emoji 😰😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="anxious face with sweat emoji 😰😰😰😰 Copy and paste & Search for any emojis 😰😰😰(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="anxious face with sweat emoji 😰 emoji 😰😰 copy and paste 😰 emoji 😰 emoji 😰😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"anxious face with sweat emoji 😰😰😰😰 Copy and paste & Search for any emojis 😰😰😰(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
