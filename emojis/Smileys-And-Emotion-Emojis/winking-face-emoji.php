...
$_GET['emojiID']="12";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="winking face emoji" description = "winking face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="winking face emoji">😉</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about winking face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="winking face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>😉</dd>
                                </dl>
...
<head>
    ...
    <title>winking face emoji 😉 emoji 😉😉 copy and paste 😉 emoji 😉 emoji 😉😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="winking face emoji 😉😉😉😉 Copy and paste & Search for any emojis 😉😉😉(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="winking face emoji 😉 emoji 😉😉 copy and paste 😉 emoji 😉 emoji 😉😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"winking face emoji 😉😉😉😉 Copy and paste & Search for any emojis 😉😉😉(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
