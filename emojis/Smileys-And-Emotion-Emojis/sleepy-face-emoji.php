...
$_GET['emojiID']="53";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="sleepy face emoji" description = "sleepy face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="sleepy face emoji">😪</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about sleepy face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="sleepy face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>😪</dd>
                                </dl>
...
<head>
    ...
    <title>sleepy face emoji 😪 emoji 😪😪 copy and paste 😪 emoji 😪 emoji 😪😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="sleepy face emoji 😪😪😪😪 Copy and paste & Search for any emojis 😪😪😪(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="sleepy face emoji 😪 emoji 😪😪 copy and paste 😪 emoji 😪 emoji 😪😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"sleepy face emoji 😪😪😪😪 Copy and paste & Search for any emojis 😪😪😪(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
