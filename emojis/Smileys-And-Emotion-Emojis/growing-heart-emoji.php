...
$_GET['emojiID']="132";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="growing heart emoji" description = "growing heart emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="growing heart emoji">💗</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about growing heart emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="growing heart emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>💗</dd>
                                </dl>
...
<head>
    ...
    <title>growing heart emoji 💗 emoji 💗💗 copy and paste 💗 emoji 💗 emoji 💗😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="growing heart emoji 💗💗💗💗 Copy and paste & Search for any emojis 💗💗💗(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="growing heart emoji 💗 emoji 💗💗 copy and paste 💗 emoji 💗 emoji 💗😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"growing heart emoji 💗💗💗💗 Copy and paste & Search for any emojis 💗💗💗(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
