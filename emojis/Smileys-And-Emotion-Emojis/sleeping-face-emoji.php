...
$_GET['emojiID']="55";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="sleeping face emoji" description = "sleeping face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="sleeping face emoji">😴</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about sleeping face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="sleeping face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>😴</dd>
                                </dl>
...
<head>
    ...
    <title>sleeping face emoji 😴 emoji 😴😴 copy and paste 😴 emoji 😴 emoji 😴😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="sleeping face emoji 😴😴😴😴 Copy and paste & Search for any emojis 😴😴😴(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="sleeping face emoji 😴 emoji 😴😴 copy and paste 😴 emoji 😴 emoji 😴😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"sleeping face emoji 😴😴😴😴 Copy and paste & Search for any emojis 😴😴😴(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
