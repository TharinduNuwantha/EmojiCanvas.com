...
$_GET['emojiID']="70";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="disguised face emoji" description = "disguised face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="disguised face emoji">🥸</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about disguised face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="disguised face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🥸</dd>
                                </dl>
...
<head>
    ...
    <title>disguised face emoji 🥸 emoji 🥸🥸 copy and paste 🥸 emoji 🥸 emoji 🥸😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="disguised face emoji 🥸🥸🥸🥸 Copy and paste & Search for any emojis 🥸🥸🥸(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="disguised face emoji 🥸 emoji 🥸🥸 copy and paste 🥸 emoji 🥸 emoji 🥸😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"disguised face emoji 🥸🥸🥸🥸 Copy and paste & Search for any emojis 🥸🥸🥸(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
