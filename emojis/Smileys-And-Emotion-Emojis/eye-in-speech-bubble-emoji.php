...
$_GET['emojiID']="162";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="eye in speech bubble emoji" description = "eye in speech bubble emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="eye in speech bubble emoji">👁️‍🗨️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about eye in speech bubble emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="eye in speech bubble emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👁️‍🗨️</dd>
                                </dl>
...
<head>
    ...
    <title>eye in speech bubble emoji 👁️‍🗨️ emoji 👁️‍🗨️👁️‍🗨️ copy and paste 👁️‍🗨️ emoji 👁️‍🗨️ emoji 👁️‍🗨️😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="eye in speech bubble emoji 👁️‍🗨️👁️‍🗨️👁️‍🗨️👁️‍🗨️ Copy and paste & Search for any emojis 👁️‍🗨️👁️‍🗨️👁️‍🗨️(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="eye in speech bubble emoji 👁️‍🗨️ emoji 👁️‍🗨️👁️‍🗨️ copy and paste 👁️‍🗨️ emoji 👁️‍🗨️ emoji 👁️‍🗨️😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"eye in speech bubble emoji 👁️‍🗨️👁️‍🗨️👁️‍🗨️👁️‍🗨️ Copy and paste & Search for any emojis 👁️‍🗨️👁️‍🗨️👁️‍🗨️(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
