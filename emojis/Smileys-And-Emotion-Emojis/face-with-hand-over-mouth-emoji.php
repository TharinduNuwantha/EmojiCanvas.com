...
$_GET['emojiID']="31";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="face with hand over mouth emoji" description = "face with hand over mouth emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="face with hand over mouth emoji">🤭</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about face with hand over mouth emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="face with hand over mouth emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🤭</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>face with hand over mouth</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
...
<head>
    ...
    <title>face with hand over mouth emoji 🤭 emoji 🤭🤭 copy and paste 🤭 emoji 🤭 emoji 🤭😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="face with hand over mouth emoji 🤭🤭🤭🤭 Copy and paste & Search for any emojis 🤭🤭🤭(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="face with hand over mouth emoji 🤭 emoji 🤭🤭 copy and paste 🤭 emoji 🤭 emoji 🤭😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"face with hand over mouth emoji 🤭🤭🤭🤭 Copy and paste & Search for any emojis 🤭🤭🤭(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
