...
$_GET['emojiID']="3";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="grinning face with smiling eyes emoji" description = "grinning face with smiling eyes emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="grinning face with smiling eyes emoji">😄</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about grinning face with smiling eyes emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="grinning face with smiling eyes emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>😄</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>grinning face with smiling eyes</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
...
<head>
    ...
    <title>grinning face with smiling eyes emoji 😄 emoji 😄😄 copy and paste 😄 emoji 😄 emoji 😄😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="grinning face with smiling eyes emoji 😄😄😄😄 Copy and paste & Search for any emojis 😄😄😄(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="grinning face with smiling eyes emoji 😄 emoji 😄😄 copy and paste 😄 emoji 😄 emoji 😄😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"grinning face with smiling eyes emoji 😄😄😄😄 Copy and paste & Search for any emojis 😄😄😄(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
