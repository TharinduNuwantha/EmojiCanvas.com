...
$_GET['emojiID']="77";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="slightly frowning face emoji" description = "slightly frowning face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="slightly frowning face emoji">🙁</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about slightly frowning face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="slightly frowning face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🙁</dd>
                                </dl>
...
<head>
    ...
    <title>slightly frowning face emoji 🙁 emoji 🙁🙁 copy and paste 🙁 emoji 🙁 emoji 🙁😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="slightly frowning face emoji 🙁🙁🙁🙁 Copy and paste & Search for any emojis 🙁🙁🙁(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="slightly frowning face emoji 🙁 emoji 🙁🙁 copy and paste 🙁 emoji 🙁 emoji 🙁😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"slightly frowning face emoji 🙁🙁🙁🙁 Copy and paste & Search for any emojis 🙁🙁🙁(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
