...
$_GET['emojiID']="23";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="smiling face with tear emoji" description = "smiling face with tear emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="smiling face with tear emoji">🥲</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about smiling face with tear emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="smiling face with tear emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🥲</dd>
                                </dl>
...
<head>
    ...
    <title>smiling face with tear emoji 🥲 emoji 🥲🥲 copy and paste 🥲 emoji 🥲 emoji 🥲😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="smiling face with tear emoji 🥲🥲🥲🥲 Copy and paste & Search for any emojis 🥲🥲🥲(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="smiling face with tear emoji 🥲 emoji 🥲🥲 copy and paste 🥲 emoji 🥲 emoji 🥲😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"smiling face with tear emoji 🥲🥲🥲🥲 Copy and paste & Search for any emojis 🥲🥲🥲(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
