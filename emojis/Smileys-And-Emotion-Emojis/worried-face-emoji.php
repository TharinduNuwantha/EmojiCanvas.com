...
$_GET['emojiID']="76";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="worried face emoji" description = "worried face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="worried face emoji">😟</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about worried face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="worried face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>😟</dd>
                                </dl>
...
<head>
    ...
    <title>worried face emoji 😟 emoji 😟😟 copy and paste 😟 emoji 😟 emoji 😟😀 😃 😄 😁 😆 😅 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="worried face emoji 😟😟😟😟 Copy and paste & Search for any emojis 😟😟😟(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="worried face emoji 😟 emoji 😟😟 copy and paste 😟 emoji 😟 emoji 😟😀 😃 😄 😁 😆 😅 " />
    <meta property="og:description"worried face emoji 😟😟😟😟 Copy and paste & Search for any emojis 😟😟😟(Smileys & Emotion)😀 😃 😄 😁 😆 😅 🤣 😂 🙂 🙃 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
