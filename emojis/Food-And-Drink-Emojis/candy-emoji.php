...
$_GET['emojiID']="783";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="candy emoji" description = "candy emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="candy emoji">🍬</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about candy emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="candy emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🍬</dd>
                                </dl>
...
<head>
    ...
    <title>candy emoji 🍬 emoji 🍬🍬 copy and paste 🍬 emoji 🍬 emoji 🍬🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="candy emoji 🍬🍬🍬🍬 Copy and paste & Search for any emojis 🍬🍬🍬(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="candy emoji 🍬 emoji 🍬🍬 copy and paste 🍬 emoji 🍬 emoji 🍬🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"candy emoji 🍬🍬🍬🍬 Copy and paste & Search for any emojis 🍬🍬🍬(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
