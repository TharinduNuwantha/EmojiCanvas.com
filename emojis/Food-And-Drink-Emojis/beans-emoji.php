...
$_GET['emojiID']="713";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="beans emoji" description = "beans emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="beans emoji">🫘</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about beans emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="beans emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🫘</dd>
                                </dl>
...
<head>
    ...
    <title>beans emoji 🫘 emoji 🫘🫘 copy and paste 🫘 emoji 🫘 emoji 🫘🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="beans emoji 🫘🫘🫘🫘 Copy and paste & Search for any emojis 🫘🫘🫘(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="beans emoji 🫘 emoji 🫘🫘 copy and paste 🫘 emoji 🫘 emoji 🫘🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"beans emoji 🫘🫘🫘🫘 Copy and paste & Search for any emojis 🫘🫘🫘(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
