...
$_GET['emojiID']="704";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="ear of corn emoji" description = "ear of corn emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="ear of corn emoji">🌽</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about ear of corn emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="ear of corn emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🌽</dd>
                                </dl>
...
<head>
    ...
    <title>ear of corn emoji 🌽 emoji 🌽🌽 copy and paste 🌽 emoji 🌽 emoji 🌽🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="ear of corn emoji 🌽🌽🌽🌽 Copy and paste & Search for any emojis 🌽🌽🌽(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="ear of corn emoji 🌽 emoji 🌽🌽 copy and paste 🌽 emoji 🌽 emoji 🌽🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"ear of corn emoji 🌽🌽🌽🌽 Copy and paste & Search for any emojis 🌽🌽🌽(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
