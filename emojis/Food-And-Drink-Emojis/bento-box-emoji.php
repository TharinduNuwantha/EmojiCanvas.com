...
$_GET['emojiID']="751";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="bento box emoji" description = "bento box emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="bento box emoji">🍱</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about bento box emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="bento box emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🍱</dd>
                                </dl>
...
<head>
    ...
    <title>bento box emoji 🍱 emoji 🍱🍱 copy and paste 🍱 emoji 🍱 emoji 🍱🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="bento box emoji 🍱🍱🍱🍱 Copy and paste & Search for any emojis 🍱🍱🍱(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="bento box emoji 🍱 emoji 🍱🍱 copy and paste 🍱 emoji 🍱 emoji 🍱🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"bento box emoji 🍱🍱🍱🍱 Copy and paste & Search for any emojis 🍱🍱🍱(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
