...
$_GET['emojiID']="696";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="kiwi fruit emoji" description = "kiwi fruit emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="kiwi fruit emoji">🥝</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about kiwi fruit emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="kiwi fruit emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🥝</dd>
                                </dl>
...
<head>
    ...
    <title>kiwi fruit emoji 🥝 emoji 🥝🥝 copy and paste 🥝 emoji 🥝 emoji 🥝🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="kiwi fruit emoji 🥝🥝🥝🥝 Copy and paste & Search for any emojis 🥝🥝🥝(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="kiwi fruit emoji 🥝 emoji 🥝🥝 copy and paste 🥝 emoji 🥝 emoji 🥝🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"kiwi fruit emoji 🥝🥝🥝🥝 Copy and paste & Search for any emojis 🥝🥝🥝(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
