...
$_GET['emojiID']="729";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="bacon emoji" description = "bacon emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="bacon emoji">🥓</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about bacon emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="bacon emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🥓</dd>
                                </dl>
...
<head>
    ...
    <title>bacon emoji 🥓 emoji 🥓🥓 copy and paste 🥓 emoji 🥓 emoji 🥓🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="bacon emoji 🥓🥓🥓🥓 Copy and paste & Search for any emojis 🥓🥓🥓(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="bacon emoji 🥓 emoji 🥓🥓 copy and paste 🥓 emoji 🥓 emoji 🥓🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"bacon emoji 🥓🥓🥓🥓 Copy and paste & Search for any emojis 🥓🥓🥓(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
