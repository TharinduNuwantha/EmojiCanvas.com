...
$_GET['emojiID']="698";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="olive emoji" description = "olive emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="olive emoji">🫒</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about olive emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="olive emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🫒</dd>
                                </dl>
...
<head>
    ...
    <title>olive emoji 🫒 emoji 🫒🫒 copy and paste 🫒 emoji 🫒 emoji 🫒🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="olive emoji 🫒🫒🫒🫒 Copy and paste & Search for any emojis 🫒🫒🫒(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="olive emoji 🫒 emoji 🫒🫒 copy and paste 🫒 emoji 🫒 emoji 🫒🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"olive emoji 🫒🫒🫒🫒 Copy and paste & Search for any emojis 🫒🫒🫒(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
