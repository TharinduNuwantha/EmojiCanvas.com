...
$_GET['emojiID']="719";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="baguette bread emoji" description = "baguette bread emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="baguette bread emoji">🥖</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about baguette bread emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="baguette bread emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🥖</dd>
                                </dl>
...
<head>
    ...
    <title>baguette bread emoji 🥖 emoji 🥖🥖 copy and paste 🥖 emoji 🥖 emoji 🥖🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="baguette bread emoji 🥖🥖🥖🥖 Copy and paste & Search for any emojis 🥖🥖🥖(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="baguette bread emoji 🥖 emoji 🥖🥖 copy and paste 🥖 emoji 🥖 emoji 🥖🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"baguette bread emoji 🥖🥖🥖🥖 Copy and paste & Search for any emojis 🥖🥖🥖(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
