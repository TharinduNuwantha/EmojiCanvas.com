...
$_GET['emojiID']="793";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="bottle with popping cork emoji" description = "bottle with popping cork emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="bottle with popping cork emoji">🍾</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about bottle with popping cork emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="bottle with popping cork emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🍾</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>bottle with popping cork</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Food & Drink</dd>
...
<head>
    ...
    <title>bottle with popping cork emoji 🍾 emoji 🍾🍾 copy and paste 🍾 emoji 🍾 emoji 🍾🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="bottle with popping cork emoji 🍾🍾🍾🍾 Copy and paste & Search for any emojis 🍾🍾🍾(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="bottle with popping cork emoji 🍾 emoji 🍾🍾 copy and paste 🍾 emoji 🍾 emoji 🍾🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"bottle with popping cork emoji 🍾🍾🍾🍾 Copy and paste & Search for any emojis 🍾🍾🍾(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
