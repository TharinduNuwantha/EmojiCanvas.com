...
$_GET['emojiID']="775";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="ice cream emoji" description = "ice cream emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="ice cream emoji">🍨</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about ice cream emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="ice cream emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🍨</dd>
                                </dl>
...
<head>
    ...
    <title>ice cream emoji 🍨 emoji 🍨🍨 copy and paste 🍨 emoji 🍨 emoji 🍨🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="ice cream emoji 🍨🍨🍨🍨 Copy and paste & Search for any emojis 🍨🍨🍨(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="ice cream emoji 🍨 emoji 🍨🍨 copy and paste 🍨 emoji 🍨 emoji 🍨🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"ice cream emoji 🍨🍨🍨🍨 Copy and paste & Search for any emojis 🍨🍨🍨(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
