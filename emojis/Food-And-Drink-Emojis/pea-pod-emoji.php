...
$_GET['emojiID']="716";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="pea pod emoji" description = "pea pod emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="pea pod emoji">🫛</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about pea pod emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="pea pod emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🫛</dd>
                                </dl>
...
<head>
    ...
    <title>pea pod emoji 🫛 emoji 🫛🫛 copy and paste 🫛 emoji 🫛 emoji 🫛🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="pea pod emoji 🫛🫛🫛🫛 Copy and paste & Search for any emojis 🫛🫛🫛(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="pea pod emoji 🫛 emoji 🫛🫛 copy and paste 🫛 emoji 🫛 emoji 🫛🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"pea pod emoji 🫛🫛🫛🫛 Copy and paste & Search for any emojis 🫛🫛🫛(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
