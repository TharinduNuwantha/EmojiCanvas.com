...
$_GET['emojiID']="755";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="curry rice emoji" description = "curry rice emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="curry rice emoji">🍛</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about curry rice emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="curry rice emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🍛</dd>
                                </dl>
...
<head>
    ...
    <title>curry rice emoji 🍛 emoji 🍛🍛 copy and paste 🍛 emoji 🍛 emoji 🍛🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="curry rice emoji 🍛🍛🍛🍛 Copy and paste & Search for any emojis 🍛🍛🍛(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="curry rice emoji 🍛 emoji 🍛🍛 copy and paste 🍛 emoji 🍛 emoji 🍛🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"curry rice emoji 🍛🍛🍛🍛 Copy and paste & Search for any emojis 🍛🍛🍛(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
