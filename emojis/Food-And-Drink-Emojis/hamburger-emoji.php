...
$_GET['emojiID']="730";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="hamburger emoji" description = "hamburger emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="hamburger emoji">🍔</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about hamburger emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="hamburger emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🍔</dd>
                                </dl>
...
<head>
    ...
    <title>hamburger emoji 🍔 emoji 🍔🍔 copy and paste 🍔 emoji 🍔 emoji 🍔🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="hamburger emoji 🍔🍔🍔🍔 Copy and paste & Search for any emojis 🍔🍔🍔(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="hamburger emoji 🍔 emoji 🍔🍔 copy and paste 🍔 emoji 🍔 emoji 🍔🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"hamburger emoji 🍔🍔🍔🍔 Copy and paste & Search for any emojis 🍔🍔🍔(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
