...
$_GET['emojiID']="731";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="french fries emoji" description = "french fries emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="french fries emoji">🍟</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about french fries emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="french fries emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🍟</dd>
                                </dl>
...
<head>
    ...
    <title>french fries emoji 🍟 emoji 🍟🍟 copy and paste 🍟 emoji 🍟 emoji 🍟🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="french fries emoji 🍟🍟🍟🍟 Copy and paste & Search for any emojis 🍟🍟🍟(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="french fries emoji 🍟 emoji 🍟🍟 copy and paste 🍟 emoji 🍟 emoji 🍟🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"french fries emoji 🍟🍟🍟🍟 Copy and paste & Search for any emojis 🍟🍟🍟(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
