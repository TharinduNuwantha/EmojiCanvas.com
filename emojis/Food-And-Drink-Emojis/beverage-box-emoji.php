...
$_GET['emojiID']="804";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="beverage box emoji" description = "beverage box emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="beverage box emoji">🧃</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about beverage box emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="beverage box emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🧃</dd>
                                </dl>
...
<head>
    ...
    <title>beverage box emoji 🧃 emoji 🧃🧃 copy and paste 🧃 emoji 🧃 emoji 🧃🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="beverage box emoji 🧃🧃🧃🧃 Copy and paste & Search for any emojis 🧃🧃🧃(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="beverage box emoji 🧃 emoji 🧃🧃 copy and paste 🧃 emoji 🧃 emoji 🧃🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"beverage box emoji 🧃🧃🧃🧃 Copy and paste & Search for any emojis 🧃🧃🧃(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
