...
$_GET['emojiID']="763";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="moon cake emoji" description = "moon cake emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="moon cake emoji">🥮</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about moon cake emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="moon cake emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🥮</dd>
                                </dl>
...
<head>
    ...
    <title>moon cake emoji 🥮 emoji 🥮🥮 copy and paste 🥮 emoji 🥮 emoji 🥮🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="moon cake emoji 🥮🥮🥮🥮 Copy and paste & Search for any emojis 🥮🥮🥮(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="moon cake emoji 🥮 emoji 🥮🥮 copy and paste 🥮 emoji 🥮 emoji 🥮🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"moon cake emoji 🥮🥮🥮🥮 Copy and paste & Search for any emojis 🥮🥮🥮(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
