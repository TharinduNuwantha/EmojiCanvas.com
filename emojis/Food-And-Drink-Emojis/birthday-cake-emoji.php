...
$_GET['emojiID']="778";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="birthday cake emoji" description = "birthday cake emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="birthday cake emoji">🎂</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about birthday cake emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="birthday cake emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎂</dd>
                                </dl>
...
<head>
    ...
    <title>birthday cake emoji 🎂 emoji 🎂🎂 copy and paste 🎂 emoji 🎂 emoji 🎂🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="birthday cake emoji 🎂🎂🎂🎂 Copy and paste & Search for any emojis 🎂🎂🎂(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="birthday cake emoji 🎂 emoji 🎂🎂 copy and paste 🎂 emoji 🎂 emoji 🎂🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"birthday cake emoji 🎂🎂🎂🎂 Copy and paste & Search for any emojis 🎂🎂🎂(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
