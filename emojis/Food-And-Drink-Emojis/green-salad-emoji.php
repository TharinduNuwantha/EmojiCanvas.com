...
$_GET['emojiID']="746";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="green salad emoji" description = "green salad emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="green salad emoji">🥗</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about green salad emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="green salad emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🥗</dd>
                                </dl>
...
<head>
    ...
    <title>green salad emoji 🥗 emoji 🥗🥗 copy and paste 🥗 emoji 🥗 emoji 🥗🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="green salad emoji 🥗🥗🥗🥗 Copy and paste & Search for any emojis 🥗🥗🥗(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="green salad emoji 🥗 emoji 🥗🥗 copy and paste 🥗 emoji 🥗 emoji 🥗🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"green salad emoji 🥗🥗🥗🥗 Copy and paste & Search for any emojis 🥗🥗🥗(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
