...
$_GET['emojiID']="788";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="glass of milk emoji" description = "glass of milk emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="glass of milk emoji">🥛</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about glass of milk emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="glass of milk emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🥛</dd>
                                </dl>
...
<head>
    ...
    <title>glass of milk emoji 🥛 emoji 🥛🥛 copy and paste 🥛 emoji 🥛 emoji 🥛🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="glass of milk emoji 🥛🥛🥛🥛 Copy and paste & Search for any emojis 🥛🥛🥛(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="glass of milk emoji 🥛 emoji 🥛🥛 copy and paste 🥛 emoji 🥛 emoji 🥛🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"glass of milk emoji 🥛🥛🥛🥛 Copy and paste & Search for any emojis 🥛🥛🥛(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
