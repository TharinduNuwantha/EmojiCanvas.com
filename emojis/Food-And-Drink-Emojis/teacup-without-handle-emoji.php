...
$_GET['emojiID']="791";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="teacup without handle emoji" description = "teacup without handle emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="teacup without handle emoji">🍵</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about teacup without handle emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="teacup without handle emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🍵</dd>
                                </dl>
...
<head>
    ...
    <title>teacup without handle emoji 🍵 emoji 🍵🍵 copy and paste 🍵 emoji 🍵 emoji 🍵🍇 🍈 🍉 🍊 🍋 🍌 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="teacup without handle emoji 🍵🍵🍵🍵 Copy and paste & Search for any emojis 🍵🍵🍵(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="teacup without handle emoji 🍵 emoji 🍵🍵 copy and paste 🍵 emoji 🍵 emoji 🍵🍇 🍈 🍉 🍊 🍋 🍌 " />
    <meta property="og:description"teacup without handle emoji 🍵🍵🍵🍵 Copy and paste & Search for any emojis 🍵🍵🍵(Food & Drink)🍇 🍈 🍉 🍊 🍋 🍌 🍍 🥭 🍎 🍏 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
