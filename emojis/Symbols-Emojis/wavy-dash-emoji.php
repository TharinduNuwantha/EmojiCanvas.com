...
$_GET['emojiID']="1575";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="wavy dash emoji" description = "wavy dash emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="wavy dash emoji">〰️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about wavy dash emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="wavy dash emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>〰️</dd>
                                </dl>
...
<head>
    ...
    <title>wavy dash emoji 〰️ emoji 〰️〰️ copy and paste 〰️ emoji 〰️ emoji 〰️🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="wavy dash emoji 〰️〰️〰️〰️ Copy and paste & Search for any emojis 〰️〰️〰️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="wavy dash emoji 〰️ emoji 〰️〰️ copy and paste 〰️ emoji 〰️ emoji 〰️🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"wavy dash emoji 〰️〰️〰️〰️ Copy and paste & Search for any emojis 〰️〰️〰️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
