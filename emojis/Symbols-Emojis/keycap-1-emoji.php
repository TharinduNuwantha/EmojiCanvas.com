...
$_GET['emojiID']="1602";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="keycap: 1 emoji" description = "keycap: 1 emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="keycap: 1 emoji">1️⃣</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about keycap: 1 emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="keycap: 1 emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>1️⃣</dd>
                                </dl>
...
<head>
    ...
    <title>keycap: 1 emoji 1️⃣ emoji 1️⃣1️⃣ copy and paste 1️⃣ emoji 1️⃣ emoji 1️⃣🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="keycap: 1 emoji 1️⃣1️⃣1️⃣1️⃣ Copy and paste & Search for any emojis 1️⃣1️⃣1️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="keycap: 1 emoji 1️⃣ emoji 1️⃣1️⃣ copy and paste 1️⃣ emoji 1️⃣ emoji 1️⃣🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"keycap: 1 emoji 1️⃣1️⃣1️⃣1️⃣ Copy and paste & Search for any emojis 1️⃣1️⃣1️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
