...
$_GET['emojiID']="1623";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="information emoji" description = "information emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="information emoji">ℹ️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about information emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="information emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>ℹ️</dd>
                                </dl>
...
<head>
    ...
    <title>information emoji ℹ️ emoji ℹ️ℹ️ copy and paste ℹ️ emoji ℹ️ emoji ℹ️🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="information emoji ℹ️ℹ️ℹ️ℹ️ Copy and paste & Search for any emojis ℹ️ℹ️ℹ️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="information emoji ℹ️ emoji ℹ️ℹ️ copy and paste ℹ️ emoji ℹ️ emoji ℹ️🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"information emoji ℹ️ℹ️ℹ️ℹ️ Copy and paste & Search for any emojis ℹ️ℹ️ℹ️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
