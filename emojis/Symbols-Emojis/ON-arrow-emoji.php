...
$_GET['emojiID']="1467";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="ON! arrow emoji" description = "ON! arrow emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="ON! arrow emoji">🔛</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about ON! arrow emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="ON! arrow emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔛</dd>
                                </dl>
...
<head>
    ...
    <title>ON! arrow emoji 🔛 emoji 🔛🔛 copy and paste 🔛 emoji 🔛 emoji 🔛🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="ON! arrow emoji 🔛🔛🔛🔛 Copy and paste & Search for any emojis 🔛🔛🔛(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="ON! arrow emoji 🔛 emoji 🔛🔛 copy and paste 🔛 emoji 🔛 emoji 🔛🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"ON! arrow emoji 🔛🔛🔛🔛 Copy and paste & Search for any emojis 🔛🔛🔛(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
