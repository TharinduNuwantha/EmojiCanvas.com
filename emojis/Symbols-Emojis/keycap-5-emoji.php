...
$_GET['emojiID']="1606";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="keycap: 5 emoji" description = "keycap: 5 emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="keycap: 5 emoji">5️⃣</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about keycap: 5 emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="keycap: 5 emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>5️⃣</dd>
                                </dl>
...
<head>
    ...
    <title>keycap: 5 emoji 5️⃣ emoji 5️⃣5️⃣ copy and paste 5️⃣ emoji 5️⃣ emoji 5️⃣🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="keycap: 5 emoji 5️⃣5️⃣5️⃣5️⃣ Copy and paste & Search for any emojis 5️⃣5️⃣5️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="keycap: 5 emoji 5️⃣ emoji 5️⃣5️⃣ copy and paste 5️⃣ emoji 5️⃣ emoji 5️⃣🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"keycap: 5 emoji 5️⃣5️⃣5️⃣5️⃣ Copy and paste & Search for any emojis 5️⃣5️⃣5️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
