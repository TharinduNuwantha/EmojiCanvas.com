...
$_GET['emojiID']="1675";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="large orange diamond emoji" description = "large orange diamond emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="large orange diamond emoji">🔶</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about large orange diamond emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="large orange diamond emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔶</dd>
                                </dl>
...
<head>
    ...
    <title>large orange diamond emoji 🔶 emoji 🔶🔶 copy and paste 🔶 emoji 🔶 emoji 🔶🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="large orange diamond emoji 🔶🔶🔶🔶 Copy and paste & Search for any emojis 🔶🔶🔶(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="large orange diamond emoji 🔶 emoji 🔶🔶 copy and paste 🔶 emoji 🔶 emoji 🔶🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"large orange diamond emoji 🔶🔶🔶🔶 Copy and paste & Search for any emojis 🔶🔶🔶(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
