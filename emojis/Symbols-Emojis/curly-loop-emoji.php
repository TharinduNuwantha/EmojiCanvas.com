...
$_GET['emojiID']="1590";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="curly loop emoji" description = "curly loop emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="curly loop emoji">➰</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about curly loop emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="curly loop emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>➰</dd>
                                </dl>
...
<head>
    ...
    <title>curly loop emoji ➰ emoji ➰➰ copy and paste ➰ emoji ➰ emoji ➰🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="curly loop emoji ➰➰➰➰ Copy and paste & Search for any emojis ➰➰➰(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="curly loop emoji ➰ emoji ➰➰ copy and paste ➰ emoji ➰ emoji ➰🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"curly loop emoji ➰➰➰➰ Copy and paste & Search for any emojis ➰➰➰(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
