...
$_GET['emojiID']="1535";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="shuffle tracks button emoji" description = "shuffle tracks button emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="shuffle tracks button emoji">🔀</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about shuffle tracks button emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="shuffle tracks button emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔀</dd>
                                </dl>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>twisted_rightwards_arrows</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>shuffle tracks button emoji 🔀 emoji 🔀🔀 copy and paste 🔀 emoji 🔀 emoji 🔀🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="shuffle tracks button emoji 🔀🔀🔀🔀 Copy and paste & Search for any emojis 🔀🔀🔀(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="shuffle tracks button emoji 🔀 emoji 🔀🔀 copy and paste 🔀 emoji 🔀 emoji 🔀🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"shuffle tracks button emoji 🔀🔀🔀🔀 Copy and paste & Search for any emojis 🔀🔀🔀(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
