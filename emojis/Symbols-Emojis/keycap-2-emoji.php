...
$_GET['emojiID']="1603";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="keycap: 2 emoji" description = "keycap: 2 emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="keycap: 2 emoji">2️⃣</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about keycap: 2 emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="keycap: 2 emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>2️⃣</dd>
                                </dl>
...
<head>
    ...
    <title>keycap: 2 emoji 2️⃣ emoji 2️⃣2️⃣ copy and paste 2️⃣ emoji 2️⃣ emoji 2️⃣🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="keycap: 2 emoji 2️⃣2️⃣2️⃣2️⃣ Copy and paste & Search for any emojis 2️⃣2️⃣2️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="keycap: 2 emoji 2️⃣ emoji 2️⃣2️⃣ copy and paste 2️⃣ emoji 2️⃣ emoji 2️⃣🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"keycap: 2 emoji 2️⃣2️⃣2️⃣2️⃣ Copy and paste & Search for any emojis 2️⃣2️⃣2️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
