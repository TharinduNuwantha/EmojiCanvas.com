...
$_GET['emojiID']="1540";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="next track button emoji" description = "next track button emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="next track button emoji">⏭️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about next track button emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="next track button emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>⏭️</dd>
                                </dl>
...
<head>
    ...
    <title>next track button emoji ⏭️ emoji ⏭️⏭️ copy and paste ⏭️ emoji ⏭️ emoji ⏭️🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="next track button emoji ⏭️⏭️⏭️⏭️ Copy and paste & Search for any emojis ⏭️⏭️⏭️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="next track button emoji ⏭️ emoji ⏭️⏭️ copy and paste ⏭️ emoji ⏭️ emoji ⏭️🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"next track button emoji ⏭️⏭️⏭️⏭️ Copy and paste & Search for any emojis ⏭️⏭️⏭️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
