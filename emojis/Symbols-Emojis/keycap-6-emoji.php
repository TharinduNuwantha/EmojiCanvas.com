...
$_GET['emojiID']="1607";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="keycap: 6 emoji" description = "keycap: 6 emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="keycap: 6 emoji">6️⃣</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about keycap: 6 emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="keycap: 6 emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>6️⃣</dd>
                                </dl>
...
<head>
    ...
    <title>keycap: 6 emoji 6️⃣ emoji 6️⃣6️⃣ copy and paste 6️⃣ emoji 6️⃣ emoji 6️⃣🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="keycap: 6 emoji 6️⃣6️⃣6️⃣6️⃣ Copy and paste & Search for any emojis 6️⃣6️⃣6️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="keycap: 6 emoji 6️⃣ emoji 6️⃣6️⃣ copy and paste 6️⃣ emoji 6️⃣ emoji 6️⃣🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"keycap: 6 emoji 6️⃣6️⃣6️⃣6️⃣ Copy and paste & Search for any emojis 6️⃣6️⃣6️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
