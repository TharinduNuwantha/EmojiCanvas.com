...
$_GET['emojiID']="1434";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="baggage claim emoji" description = "baggage claim emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="baggage claim emoji">🛄</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about baggage claim emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="baggage claim emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🛄</dd>
                                </dl>
...
<head>
    ...
    <title>baggage claim emoji 🛄 emoji 🛄🛄 copy and paste 🛄 emoji 🛄 emoji 🛄🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="baggage claim emoji 🛄🛄🛄🛄 Copy and paste & Search for any emojis 🛄🛄🛄(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="baggage claim emoji 🛄 emoji 🛄🛄 copy and paste 🛄 emoji 🛄 emoji 🛄🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"baggage claim emoji 🛄🛄🛄🛄 Copy and paste & Search for any emojis 🛄🛄🛄(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
