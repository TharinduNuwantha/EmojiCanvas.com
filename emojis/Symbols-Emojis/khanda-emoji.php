...
$_GET['emojiID']="1482";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="khanda emoji" description = "khanda emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="khanda emoji">🪯</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about khanda emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="khanda emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🪯</dd>
                                </dl>
...
<head>
    ...
    <title>khanda emoji 🪯 emoji 🪯🪯 copy and paste 🪯 emoji 🪯 emoji 🪯🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="khanda emoji 🪯🪯🪯🪯 Copy and paste & Search for any emojis 🪯🪯🪯(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="khanda emoji 🪯 emoji 🪯🪯 copy and paste 🪯 emoji 🪯 emoji 🪯🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"khanda emoji 🪯🪯🪯🪯 Copy and paste & Search for any emojis 🪯🪯🪯(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
