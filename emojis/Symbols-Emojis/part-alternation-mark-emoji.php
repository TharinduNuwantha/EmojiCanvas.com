...
$_GET['emojiID']="1592";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="part alternation mark emoji" description = "part alternation mark emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="part alternation mark emoji">〽️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about part alternation mark emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="part alternation mark emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>〽️</dd>
                                </dl>
...
<head>
    ...
    <title>part alternation mark emoji 〽️ emoji 〽️〽️ copy and paste 〽️ emoji 〽️ emoji 〽️🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="part alternation mark emoji 〽️〽️〽️〽️ Copy and paste & Search for any emojis 〽️〽️〽️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="part alternation mark emoji 〽️ emoji 〽️〽️ copy and paste 〽️ emoji 〽️ emoji 〽️🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"part alternation mark emoji 〽️〽️〽️〽️ Copy and paste & Search for any emojis 〽️〽️〽️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
