...
$_GET['emojiID']="1460";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="left arrow curving right emoji" description = "left arrow curving right emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="left arrow curving right emoji">↪️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about left arrow curving right emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="left arrow curving right emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>↪️</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>left arrow curving right</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Symbols</dd>
...
<head>
    ...
    <title>left arrow curving right emoji ↪️ emoji ↪️↪️ copy and paste ↪️ emoji ↪️ emoji ↪️🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="left arrow curving right emoji ↪️↪️↪️↪️ Copy and paste & Search for any emojis ↪️↪️↪️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="left arrow curving right emoji ↪️ emoji ↪️↪️ copy and paste ↪️ emoji ↪️ emoji ↪️🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"left arrow curving right emoji ↪️↪️↪️↪️ Copy and paste & Search for any emojis ↪️↪️↪️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
