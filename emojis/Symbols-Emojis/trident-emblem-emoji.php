...
$_GET['emojiID']="1581";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="trident emblem emoji" description = "trident emblem emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="trident emblem emoji">🔱</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about trident emblem emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="trident emblem emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔱</dd>
                                </dl>
...
<head>
    ...
    <title>trident emblem emoji 🔱 emoji 🔱🔱 copy and paste 🔱 emoji 🔱 emoji 🔱🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="trident emblem emoji 🔱🔱🔱🔱 Copy and paste & Search for any emojis 🔱🔱🔱(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="trident emblem emoji 🔱 emoji 🔱🔱 copy and paste 🔱 emoji 🔱 emoji 🔱🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"trident emblem emoji 🔱🔱🔱🔱 Copy and paste & Search for any emojis 🔱🔱🔱(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
