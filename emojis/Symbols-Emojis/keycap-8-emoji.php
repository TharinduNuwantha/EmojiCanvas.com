...
$_GET['emojiID']="1609";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="keycap: 8 emoji" description = "keycap: 8 emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="keycap: 8 emoji">8️⃣</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about keycap: 8 emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="keycap: 8 emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>8️⃣</dd>
                                </dl>
...
<head>
    ...
    <title>keycap: 8 emoji 8️⃣ emoji 8️⃣8️⃣ copy and paste 8️⃣ emoji 8️⃣ emoji 8️⃣🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="keycap: 8 emoji 8️⃣8️⃣8️⃣8️⃣ Copy and paste & Search for any emojis 8️⃣8️⃣8️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="keycap: 8 emoji 8️⃣ emoji 8️⃣8️⃣ copy and paste 8️⃣ emoji 8️⃣ emoji 8️⃣🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"keycap: 8 emoji 8️⃣8️⃣8️⃣8️⃣ Copy and paste & Search for any emojis 8️⃣8️⃣8️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
