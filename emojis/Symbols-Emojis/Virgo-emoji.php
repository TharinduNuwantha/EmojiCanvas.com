...
$_GET['emojiID']="1527";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="Virgo emoji" description = "Virgo emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="Virgo emoji">♍</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about Virgo emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="Virgo emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>♍</dd>
                                </dl>
...
<head>
    ...
    <title>Virgo emoji ♍ emoji ♍♍ copy and paste ♍ emoji ♍ emoji ♍🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="Virgo emoji ♍♍♍♍ Copy and paste & Search for any emojis ♍♍♍(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="Virgo emoji ♍ emoji ♍♍ copy and paste ♍ emoji ♍ emoji ♍🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"Virgo emoji ♍♍♍♍ Copy and paste & Search for any emojis ♍♍♍(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
