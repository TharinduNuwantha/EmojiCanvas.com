...
$_GET['emojiID']="1610";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="keycap: 9 emoji" description = "keycap: 9 emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="keycap: 9 emoji">9️⃣</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about keycap: 9 emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="keycap: 9 emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>9️⃣</dd>
                                </dl>
...
<head>
    ...
    <title>keycap: 9 emoji 9️⃣ emoji 9️⃣9️⃣ copy and paste 9️⃣ emoji 9️⃣ emoji 9️⃣🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="keycap: 9 emoji 9️⃣9️⃣9️⃣9️⃣ Copy and paste & Search for any emojis 9️⃣9️⃣9️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="keycap: 9 emoji 9️⃣ emoji 9️⃣9️⃣ copy and paste 9️⃣ emoji 9️⃣ emoji 9️⃣🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"keycap: 9 emoji 9️⃣9️⃣9️⃣9️⃣ Copy and paste & Search for any emojis 9️⃣9️⃣9️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
