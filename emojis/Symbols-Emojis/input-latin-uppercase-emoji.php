...
$_GET['emojiID']="1612";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="input latin uppercase emoji" description = "input latin uppercase emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="input latin uppercase emoji">🔠</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about input latin uppercase emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="input latin uppercase emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔠</dd>
                                </dl>
...
<head>
    ...
    <title>input latin uppercase emoji 🔠 emoji 🔠🔠 copy and paste 🔠 emoji 🔠 emoji 🔠🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="input latin uppercase emoji 🔠🔠🔠🔠 Copy and paste & Search for any emojis 🔠🔠🔠(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="input latin uppercase emoji 🔠 emoji 🔠🔠 copy and paste 🔠 emoji 🔠 emoji 🔠🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"input latin uppercase emoji 🔠🔠🔠🔠 Copy and paste & Search for any emojis 🔠🔠🔠(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
