...
$_GET['emojiID']="1463";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="clockwise vertical arrows emoji" description = "clockwise vertical arrows emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="clockwise vertical arrows emoji">🔃</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about clockwise vertical arrows emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="clockwise vertical arrows emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔃</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>clockwise vertical arrows</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Symbols</dd>
...
<head>
    ...
    <title>clockwise vertical arrows emoji 🔃 emoji 🔃🔃 copy and paste 🔃 emoji 🔃 emoji 🔃🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="clockwise vertical arrows emoji 🔃🔃🔃🔃 Copy and paste & Search for any emojis 🔃🔃🔃(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="clockwise vertical arrows emoji 🔃 emoji 🔃🔃 copy and paste 🔃 emoji 🔃 emoji 🔃🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"clockwise vertical arrows emoji 🔃🔃🔃🔃 Copy and paste & Search for any emojis 🔃🔃🔃(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
