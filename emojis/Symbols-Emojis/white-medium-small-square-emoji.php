...
$_GET['emojiID']="1672";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="white medium-small square emoji" description = "white medium-small square emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="white medium-small square emoji">◽</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about white medium-small square emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="white medium-small square emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>◽</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>white medium-small square</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Symbols</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>white_medium_small_square</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>white medium-small square emoji ◽ emoji ◽◽ copy and paste ◽ emoji ◽ emoji ◽🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="white medium-small square emoji ◽◽◽◽ Copy and paste & Search for any emojis ◽◽◽(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="white medium-small square emoji ◽ emoji ◽◽ copy and paste ◽ emoji ◽ emoji ◽🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"white medium-small square emoji ◽◽◽◽ Copy and paste & Search for any emojis ◽◽◽(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
