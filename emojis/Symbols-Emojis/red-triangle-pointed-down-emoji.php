...
$_GET['emojiID']="1680";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="red triangle pointed down emoji" description = "red triangle pointed down emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="red triangle pointed down emoji">🔻</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about red triangle pointed down emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="red triangle pointed down emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔻</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>red triangle pointed down</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Symbols</dd>
...
<head>
    ...
    <title>red triangle pointed down emoji 🔻 emoji 🔻🔻 copy and paste 🔻 emoji 🔻 emoji 🔻🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="red triangle pointed down emoji 🔻🔻🔻🔻 Copy and paste & Search for any emojis 🔻🔻🔻(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="red triangle pointed down emoji 🔻 emoji 🔻🔻 copy and paste 🔻 emoji 🔻 emoji 🔻🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"red triangle pointed down emoji 🔻🔻🔻🔻 Copy and paste & Search for any emojis 🔻🔻🔻(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
