...
$_GET['emojiID']="1667";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="black large square emoji" description = "black large square emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="black large square emoji">⬛</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about black large square emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="black large square emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>⬛</dd>
                                </dl>
...
<head>
    ...
    <title>black large square emoji ⬛ emoji ⬛⬛ copy and paste ⬛ emoji ⬛ emoji ⬛🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="black large square emoji ⬛⬛⬛⬛ Copy and paste & Search for any emojis ⬛⬛⬛(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="black large square emoji ⬛ emoji ⬛⬛ copy and paste ⬛ emoji ⬛ emoji ⬛🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"black large square emoji ⬛⬛⬛⬛ Copy and paste & Search for any emojis ⬛⬛⬛(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
