...
$_GET['emojiID']="1622";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="FREE button emoji" description = "FREE button emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="FREE button emoji">🆓</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about FREE button emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="FREE button emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🆓</dd>
                                </dl>
...
<head>
    ...
    <title>FREE button emoji 🆓 emoji 🆓🆓 copy and paste 🆓 emoji 🆓 emoji 🆓🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="FREE button emoji 🆓🆓🆓🆓 Copy and paste & Search for any emojis 🆓🆓🆓(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="FREE button emoji 🆓 emoji 🆓🆓 copy and paste 🆓 emoji 🆓 emoji 🆓🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"FREE button emoji 🆓🆓🆓🆓 Copy and paste & Search for any emojis 🆓🆓🆓(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
