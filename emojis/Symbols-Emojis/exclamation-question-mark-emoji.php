...
$_GET['emojiID']="1570";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="exclamation question mark emoji" description = "exclamation question mark emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="exclamation question mark emoji">⁉️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about exclamation question mark emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="exclamation question mark emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>⁉️</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>exclamation question mark</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Symbols</dd>
...
<head>
    ...
    <title>exclamation question mark emoji ⁉️ emoji ⁉️⁉️ copy and paste ⁉️ emoji ⁉️ emoji ⁉️🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="exclamation question mark emoji ⁉️⁉️⁉️⁉️ Copy and paste & Search for any emojis ⁉️⁉️⁉️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="exclamation question mark emoji ⁉️ emoji ⁉️⁉️ copy and paste ⁉️ emoji ⁉️ emoji ⁉️🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"exclamation question mark emoji ⁉️⁉️⁉️⁉️ Copy and paste & Search for any emojis ⁉️⁉️⁉️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
