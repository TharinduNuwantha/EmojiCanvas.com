...
$_GET['emojiID']="1638";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="Japanese “reserved” button emoji" description = "Japanese “reserved” button emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="Japanese “reserved” button emoji">🈯</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about Japanese “reserved” button emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="Japanese “reserved” button emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🈯</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>Japanese “reserved” button</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Symbols</dd>
...
<head>
    ...
    <title>Japanese “reserved” button emoji 🈯 emoji 🈯🈯 copy and paste 🈯 emoji 🈯 emoji 🈯🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="Japanese “reserved” button emoji 🈯🈯🈯🈯 Copy and paste & Search for any emojis 🈯🈯🈯(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="Japanese “reserved” button emoji 🈯 emoji 🈯🈯 copy and paste 🈯 emoji 🈯 emoji 🈯🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"Japanese “reserved” button emoji 🈯🈯🈯🈯 Copy and paste & Search for any emojis 🈯🈯🈯(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
