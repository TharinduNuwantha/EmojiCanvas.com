...
$_GET['emojiID']="1589";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="cross mark button emoji" description = "cross mark button emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="cross mark button emoji">❎</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about cross mark button emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="cross mark button emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>❎</dd>
                                </dl>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>negative_squared_cross_mark</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>cross mark button emoji ❎ emoji ❎❎ copy and paste ❎ emoji ❎ emoji ❎🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="cross mark button emoji ❎❎❎❎ Copy and paste & Search for any emojis ❎❎❎(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="cross mark button emoji ❎ emoji ❎❎ copy and paste ❎ emoji ❎ emoji ❎🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"cross mark button emoji ❎❎❎❎ Copy and paste & Search for any emojis ❎❎❎(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
