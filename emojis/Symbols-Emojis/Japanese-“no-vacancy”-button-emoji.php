...
$_GET['emojiID']="1650";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="Japanese “no vacancy” button emoji" description = "Japanese “no vacancy” button emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="Japanese “no vacancy” button emoji">🈵</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about Japanese “no vacancy” button emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="Japanese “no vacancy” button emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🈵</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>Japanese “no vacancy” button</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Symbols</dd>
...
<head>
    ...
    <title>Japanese “no vacancy” button emoji 🈵 emoji 🈵🈵 copy and paste 🈵 emoji 🈵 emoji 🈵🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="Japanese “no vacancy” button emoji 🈵🈵🈵🈵 Copy and paste & Search for any emojis 🈵🈵🈵(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="Japanese “no vacancy” button emoji 🈵 emoji 🈵🈵 copy and paste 🈵 emoji 🈵 emoji 🈵🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"Japanese “no vacancy” button emoji 🈵🈵🈵🈵 Copy and paste & Search for any emojis 🈵🈵🈵(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
