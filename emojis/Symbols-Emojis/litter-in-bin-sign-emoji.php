...
$_GET['emojiID']="1424";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="litter in bin sign emoji" description = "litter in bin sign emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="litter in bin sign emoji">🚮</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about litter in bin sign emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="litter in bin sign emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🚮</dd>
                                </dl>
...
<head>
    ...
    <title>litter in bin sign emoji 🚮 emoji 🚮🚮 copy and paste 🚮 emoji 🚮 emoji 🚮🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="litter in bin sign emoji 🚮🚮🚮🚮 Copy and paste & Search for any emojis 🚮🚮🚮(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="litter in bin sign emoji 🚮 emoji 🚮🚮 copy and paste 🚮 emoji 🚮 emoji 🚮🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"litter in bin sign emoji 🚮🚮🚮🚮 Copy and paste & Search for any emojis 🚮🚮🚮(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
