...
$_GET['emojiID']="1628";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="O button (blood type) emoji" description = "O button (blood type) emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="O button (blood type) emoji">🅾️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about O button (blood type) emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="O button (blood type) emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🅾️</dd>
                                </dl>
...
<head>
    ...
    <title>O button (blood type) emoji 🅾️ emoji 🅾️🅾️ copy and paste 🅾️ emoji 🅾️ emoji 🅾️🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="O button (blood type) emoji 🅾️🅾️🅾️🅾️ Copy and paste & Search for any emojis 🅾️🅾️🅾️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="O button (blood type) emoji 🅾️ emoji 🅾️🅾️ copy and paste 🅾️ emoji 🅾️ emoji 🅾️🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"O button (blood type) emoji 🅾️🅾️🅾️🅾️ Copy and paste & Search for any emojis 🅾️🅾️🅾️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
