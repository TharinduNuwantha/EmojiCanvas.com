...
$_GET['emojiID']="1668";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="white large square emoji" description = "white large square emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="white large square emoji">⬜</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about white large square emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="white large square emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>⬜</dd>
                                </dl>
...
<head>
    ...
    <title>white large square emoji ⬜ emoji ⬜⬜ copy and paste ⬜ emoji ⬜ emoji ⬜🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="white large square emoji ⬜⬜⬜⬜ Copy and paste & Search for any emojis ⬜⬜⬜(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="white large square emoji ⬜ emoji ⬜⬜ copy and paste ⬜ emoji ⬜ emoji ⬜🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"white large square emoji ⬜⬜⬜⬜ Copy and paste & Search for any emojis ⬜⬜⬜(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
