...
$_GET['emojiID']="1432";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="passport control emoji" description = "passport control emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="passport control emoji">🛂</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about passport control emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="passport control emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🛂</dd>
                                </dl>
...
<head>
    ...
    <title>passport control emoji 🛂 emoji 🛂🛂 copy and paste 🛂 emoji 🛂 emoji 🛂🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="passport control emoji 🛂🛂🛂🛂 Copy and paste & Search for any emojis 🛂🛂🛂(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="passport control emoji 🛂 emoji 🛂🛂 copy and paste 🛂 emoji 🛂 emoji 🛂🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"passport control emoji 🛂🛂🛂🛂 Copy and paste & Search for any emojis 🛂🛂🛂(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
