...
$_GET['emojiID']="1605";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="keycap: 4 emoji" description = "keycap: 4 emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="keycap: 4 emoji">4️⃣</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about keycap: 4 emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="keycap: 4 emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>4️⃣</dd>
                                </dl>
...
<head>
    ...
    <title>keycap: 4 emoji 4️⃣ emoji 4️⃣4️⃣ copy and paste 4️⃣ emoji 4️⃣ emoji 4️⃣🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="keycap: 4 emoji 4️⃣4️⃣4️⃣4️⃣ Copy and paste & Search for any emojis 4️⃣4️⃣4️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="keycap: 4 emoji 4️⃣ emoji 4️⃣4️⃣ copy and paste 4️⃣ emoji 4️⃣ emoji 4️⃣🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"keycap: 4 emoji 4️⃣4️⃣4️⃣4️⃣ Copy and paste & Search for any emojis 4️⃣4️⃣4️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
