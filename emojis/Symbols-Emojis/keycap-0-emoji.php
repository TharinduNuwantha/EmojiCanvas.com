...
$_GET['emojiID']="1601";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="keycap: 0 emoji" description = "keycap: 0 emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="keycap: 0 emoji">0️⃣</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about keycap: 0 emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="keycap: 0 emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>0️⃣</dd>
                                </dl>
...
<head>
    ...
    <title>keycap: 0 emoji 0️⃣ emoji 0️⃣0️⃣ copy and paste 0️⃣ emoji 0️⃣ emoji 0️⃣🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="keycap: 0 emoji 0️⃣0️⃣0️⃣0️⃣ Copy and paste & Search for any emojis 0️⃣0️⃣0️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="keycap: 0 emoji 0️⃣ emoji 0️⃣0️⃣ copy and paste 0️⃣ emoji 0️⃣ emoji 0️⃣🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"keycap: 0 emoji 0️⃣0️⃣0️⃣0️⃣ Copy and paste & Search for any emojis 0️⃣0️⃣0️⃣(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
