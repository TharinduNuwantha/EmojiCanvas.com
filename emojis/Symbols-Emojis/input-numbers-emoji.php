...
$_GET['emojiID']="1614";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="input numbers emoji" description = "input numbers emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="input numbers emoji">🔢</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about input numbers emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="input numbers emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔢</dd>
                                </dl>
...
<head>
    ...
    <title>input numbers emoji 🔢 emoji 🔢🔢 copy and paste 🔢 emoji 🔢 emoji 🔢🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="input numbers emoji 🔢🔢🔢🔢 Copy and paste & Search for any emojis 🔢🔢🔢(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="input numbers emoji 🔢 emoji 🔢🔢 copy and paste 🔢 emoji 🔢 emoji 🔢🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"input numbers emoji 🔢🔢🔢🔢 Copy and paste & Search for any emojis 🔢🔢🔢(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
