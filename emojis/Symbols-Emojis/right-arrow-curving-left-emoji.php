...
$_GET['emojiID']="1459";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="right arrow curving left emoji" description = "right arrow curving left emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="right arrow curving left emoji">↩️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about right arrow curving left emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="right arrow curving left emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>↩️</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>right arrow curving left</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Symbols</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>leftwards_arrow_with_hook</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>right arrow curving left emoji ↩️ emoji ↩️↩️ copy and paste ↩️ emoji ↩️ emoji ↩️🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="right arrow curving left emoji ↩️↩️↩️↩️ Copy and paste & Search for any emojis ↩️↩️↩️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="right arrow curving left emoji ↩️ emoji ↩️↩️ copy and paste ↩️ emoji ↩️ emoji ↩️🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"right arrow curving left emoji ↩️↩️↩️↩️ Copy and paste & Search for any emojis ↩️↩️↩️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
