...
$_GET['emojiID']="1470";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="place of worship emoji" description = "place of worship emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="place of worship emoji">🛐</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about place of worship emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="place of worship emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🛐</dd>
                                </dl>
...
<head>
    ...
    <title>place of worship emoji 🛐 emoji 🛐🛐 copy and paste 🛐 emoji 🛐 emoji 🛐🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="place of worship emoji 🛐🛐🛐🛐 Copy and paste & Search for any emojis 🛐🛐🛐(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="place of worship emoji 🛐 emoji 🛐🛐 copy and paste 🛐 emoji 🛐 emoji 🛐🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"place of worship emoji 🛐🛐🛐🛐 Copy and paste & Search for any emojis 🛐🛐🛐(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
