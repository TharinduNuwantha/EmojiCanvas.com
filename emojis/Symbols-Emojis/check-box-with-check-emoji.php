...
$_GET['emojiID']="1586";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="check box with check emoji" description = "check box with check emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="check box with check emoji">☑️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about check box with check emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="check box with check emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>☑️</dd>
                                </dl>
...
<head>
    ...
    <title>check box with check emoji ☑️ emoji ☑️☑️ copy and paste ☑️ emoji ☑️ emoji ☑️🤬 🏧 🚮 🚰 ♿ 🚹 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="check box with check emoji ☑️☑️☑️☑️ Copy and paste & Search for any emojis ☑️☑️☑️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="check box with check emoji ☑️ emoji ☑️☑️ copy and paste ☑️ emoji ☑️ emoji ☑️🤬 🏧 🚮 🚰 ♿ 🚹 " />
    <meta property="og:description"check box with check emoji ☑️☑️☑️☑️ Copy and paste & Search for any emojis ☑️☑️☑️(Symbols)🤬 🏧 🚮 🚰 ♿ 🚹 🚺 🚻 🚼 🚾 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
