...
$_GET['emojiID']="1064";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="american football emoji" description = "american football emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="american football emoji">🏈</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about american football emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="american football emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🏈</dd>
                                </dl>
...
<head>
    ...
    <title>american football emoji 🏈 emoji 🏈🏈 copy and paste 🏈 emoji 🏈 emoji 🏈🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="american football emoji 🏈🏈🏈🏈 Copy and paste & Search for any emojis 🏈🏈🏈(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="american football emoji 🏈 emoji 🏈🏈 copy and paste 🏈 emoji 🏈 emoji 🏈🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"american football emoji 🏈🏈🏈🏈 Copy and paste & Search for any emojis 🏈🏈🏈(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
