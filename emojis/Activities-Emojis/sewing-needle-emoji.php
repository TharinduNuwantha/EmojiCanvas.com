...
$_GET['emojiID']="1114";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="sewing needle emoji" description = "sewing needle emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="sewing needle emoji">🪡</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about sewing needle emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="sewing needle emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🪡</dd>
                                </dl>
...
<head>
    ...
    <title>sewing needle emoji 🪡 emoji 🪡🪡 copy and paste 🪡 emoji 🪡 emoji 🪡🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="sewing needle emoji 🪡🪡🪡🪡 Copy and paste & Search for any emojis 🪡🪡🪡(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="sewing needle emoji 🪡 emoji 🪡🪡 copy and paste 🪡 emoji 🪡 emoji 🪡🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"sewing needle emoji 🪡🪡🪡🪡 Copy and paste & Search for any emojis 🪡🪡🪡(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
