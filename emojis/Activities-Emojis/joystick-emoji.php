...
$_GET['emojiID']="1094";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="joystick emoji" description = "joystick emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="joystick emoji">🕹️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about joystick emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="joystick emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🕹️</dd>
                                </dl>
...
<head>
    ...
    <title>joystick emoji 🕹️ emoji 🕹️🕹️ copy and paste 🕹️ emoji 🕹️ emoji 🕹️🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="joystick emoji 🕹️🕹️🕹️🕹️ Copy and paste & Search for any emojis 🕹️🕹️🕹️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="joystick emoji 🕹️ emoji 🕹️🕹️ copy and paste 🕹️ emoji 🕹️ emoji 🕹️🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"joystick emoji 🕹️🕹️🕹️🕹️ Copy and paste & Search for any emojis 🕹️🕹️🕹️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
