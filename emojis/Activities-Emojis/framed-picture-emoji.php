...
$_GET['emojiID']="1111";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="framed picture emoji" description = "framed picture emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="framed picture emoji">🖼️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about framed picture emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="framed picture emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🖼️</dd>
                                </dl>
...
<head>
    ...
    <title>framed picture emoji 🖼️ emoji 🖼️🖼️ copy and paste 🖼️ emoji 🖼️ emoji 🖼️🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="framed picture emoji 🖼️🖼️🖼️🖼️ Copy and paste & Search for any emojis 🖼️🖼️🖼️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="framed picture emoji 🖼️ emoji 🖼️🖼️ copy and paste 🖼️ emoji 🖼️ emoji 🖼️🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"framed picture emoji 🖼️🖼️🖼️🖼️ Copy and paste & Search for any emojis 🖼️🖼️🖼️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
