...
$_GET['emojiID']="1042";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="pine decoration emoji" description = "pine decoration emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="pine decoration emoji">🎍</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about pine decoration emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="pine decoration emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎍</dd>
                                </dl>
...
<head>
    ...
    <title>pine decoration emoji 🎍 emoji 🎍🎍 copy and paste 🎍 emoji 🎍 emoji 🎍🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="pine decoration emoji 🎍🎍🎍🎍 Copy and paste & Search for any emojis 🎍🎍🎍(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="pine decoration emoji 🎍 emoji 🎍🎍 copy and paste 🎍 emoji 🎍 emoji 🎍🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"pine decoration emoji 🎍🎍🎍🎍 Copy and paste & Search for any emojis 🎍🎍🎍(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
