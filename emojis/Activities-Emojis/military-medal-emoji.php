...
$_GET['emojiID']="1053";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="military medal emoji" description = "military medal emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="military medal emoji">🎖️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about military medal emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="military medal emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎖️</dd>
                                </dl>
...
<head>
    ...
    <title>military medal emoji 🎖️ emoji 🎖️🎖️ copy and paste 🎖️ emoji 🎖️ emoji 🎖️🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="military medal emoji 🎖️🎖️🎖️🎖️ Copy and paste & Search for any emojis 🎖️🎖️🎖️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="military medal emoji 🎖️ emoji 🎖️🎖️ copy and paste 🎖️ emoji 🎖️ emoji 🎖️🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"military medal emoji 🎖️🎖️🎖️🎖️ Copy and paste & Search for any emojis 🎖️🎖️🎖️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
