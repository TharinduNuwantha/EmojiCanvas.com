...
$_GET['emojiID']="1104";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="diamond suit emoji" description = "diamond suit emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="diamond suit emoji">♦️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about diamond suit emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="diamond suit emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>♦️</dd>
                                </dl>
...
<head>
    ...
    <title>diamond suit emoji ♦️ emoji ♦️♦️ copy and paste ♦️ emoji ♦️ emoji ♦️🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="diamond suit emoji ♦️♦️♦️♦️ Copy and paste & Search for any emojis ♦️♦️♦️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="diamond suit emoji ♦️ emoji ♦️♦️ copy and paste ♦️ emoji ♦️ emoji ♦️🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"diamond suit emoji ♦️♦️♦️♦️ Copy and paste & Search for any emojis ♦️♦️♦️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
