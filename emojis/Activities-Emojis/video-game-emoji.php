...
$_GET['emojiID']="1093";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="video game emoji" description = "video game emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="video game emoji">🎮</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about video game emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="video game emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎮</dd>
                                </dl>
...
<head>
    ...
    <title>video game emoji 🎮 emoji 🎮🎮 copy and paste 🎮 emoji 🎮 emoji 🎮🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="video game emoji 🎮🎮🎮🎮 Copy and paste & Search for any emojis 🎮🎮🎮(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="video game emoji 🎮 emoji 🎮🎮 copy and paste 🎮 emoji 🎮 emoji 🎮🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"video game emoji 🎮🎮🎮🎮 Copy and paste & Search for any emojis 🎮🎮🎮(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
