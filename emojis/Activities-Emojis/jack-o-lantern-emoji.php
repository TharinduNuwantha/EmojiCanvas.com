...
$_GET['emojiID']="1032";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="jack-o-lantern emoji" description = "jack-o-lantern emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="jack-o-lantern emoji">🎃</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about jack-o-lantern emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="jack-o-lantern emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎃</dd>
                                </dl>
...
<head>
    ...
    <title>jack-o-lantern emoji 🎃 emoji 🎃🎃 copy and paste 🎃 emoji 🎃 emoji 🎃🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="jack-o-lantern emoji 🎃🎃🎃🎃 Copy and paste & Search for any emojis 🎃🎃🎃(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="jack-o-lantern emoji 🎃 emoji 🎃🎃 copy and paste 🎃 emoji 🎃 emoji 🎃🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"jack-o-lantern emoji 🎃🎃🎃🎃 Copy and paste & Search for any emojis 🎃🎃🎃(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
