...
$_GET['emojiID']="1041";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="tanabata tree emoji" description = "tanabata tree emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="tanabata tree emoji">🎋</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about tanabata tree emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="tanabata tree emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎋</dd>
                                </dl>
...
<head>
    ...
    <title>tanabata tree emoji 🎋 emoji 🎋🎋 copy and paste 🎋 emoji 🎋 emoji 🎋🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="tanabata tree emoji 🎋🎋🎋🎋 Copy and paste & Search for any emojis 🎋🎋🎋(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="tanabata tree emoji 🎋 emoji 🎋🎋 copy and paste 🎋 emoji 🎋 emoji 🎋🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"tanabata tree emoji 🎋🎋🎋🎋 Copy and paste & Search for any emojis 🎋🎋🎋(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
