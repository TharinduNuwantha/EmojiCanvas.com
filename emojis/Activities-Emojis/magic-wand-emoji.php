...
$_GET['emojiID']="1092";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="magic wand emoji" description = "magic wand emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="magic wand emoji">🪄</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about magic wand emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="magic wand emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🪄</dd>
                                </dl>
...
<head>
    ...
    <title>magic wand emoji 🪄 emoji 🪄🪄 copy and paste 🪄 emoji 🪄 emoji 🪄🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="magic wand emoji 🪄🪄🪄🪄 Copy and paste & Search for any emojis 🪄🪄🪄(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="magic wand emoji 🪄 emoji 🪄🪄 copy and paste 🪄 emoji 🪄 emoji 🪄🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"magic wand emoji 🪄🪄🪄🪄 Copy and paste & Search for any emojis 🪄🪄🪄(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
