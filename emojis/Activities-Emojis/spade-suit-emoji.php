...
$_GET['emojiID']="1102";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="spade suit emoji" description = "spade suit emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="spade suit emoji">♠️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about spade suit emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="spade suit emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>♠️</dd>
                                </dl>
...
<head>
    ...
    <title>spade suit emoji ♠️ emoji ♠️♠️ copy and paste ♠️ emoji ♠️ emoji ♠️🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="spade suit emoji ♠️♠️♠️♠️ Copy and paste & Search for any emojis ♠️♠️♠️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="spade suit emoji ♠️ emoji ♠️♠️ copy and paste ♠️ emoji ♠️ emoji ♠️🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"spade suit emoji ♠️♠️♠️♠️ Copy and paste & Search for any emojis ♠️♠️♠️(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
