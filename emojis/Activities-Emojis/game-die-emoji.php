...
$_GET['emojiID']="1096";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="game die emoji" description = "game die emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="game die emoji">🎲</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about game die emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="game die emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎲</dd>
                                </dl>
...
<head>
    ...
    <title>game die emoji 🎲 emoji 🎲🎲 copy and paste 🎲 emoji 🎲 emoji 🎲🎃 🎄 🎆 🎇 🧨 ✨ </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="game die emoji 🎲🎲🎲🎲 Copy and paste & Search for any emojis 🎲🎲🎲(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="game die emoji 🎲 emoji 🎲🎲 copy and paste 🎲 emoji 🎲 emoji 🎲🎃 🎄 🎆 🎇 🧨 ✨ " />
    <meta property="og:description"game die emoji 🎲🎲🎲🎲 Copy and paste & Search for any emojis 🎲🎲🎲(Activities)🎃 🎄 🎆 🎇 🧨 ✨ 🎈 🎉 🎊 🎋 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
