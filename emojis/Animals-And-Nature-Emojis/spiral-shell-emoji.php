...
$_GET['emojiID']="634";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="spiral shell emoji" description = "spiral shell emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="spiral shell emoji">🐚</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about spiral shell emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="spiral shell emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🐚</dd>
                                </dl>
...
<head>
    ...
    <title>spiral shell emoji 🐚 emoji 🐚🐚 copy and paste 🐚 emoji 🐚 emoji 🐚🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="spiral shell emoji 🐚🐚🐚🐚 Copy and paste & Search for any emojis 🐚🐚🐚(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="spiral shell emoji 🐚 emoji 🐚🐚 copy and paste 🐚 emoji 🐚 emoji 🐚🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"spiral shell emoji 🐚🐚🐚🐚 Copy and paste & Search for any emojis 🐚🐚🐚(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
