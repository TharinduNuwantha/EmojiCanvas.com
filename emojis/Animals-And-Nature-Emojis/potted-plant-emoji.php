...
$_GET['emojiID']="666";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="potted plant emoji" description = "potted plant emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="potted plant emoji">🪴</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about potted plant emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="potted plant emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🪴</dd>
                                </dl>
...
<head>
    ...
    <title>potted plant emoji 🪴 emoji 🪴🪴 copy and paste 🪴 emoji 🪴 emoji 🪴🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="potted plant emoji 🪴🪴🪴🪴 Copy and paste & Search for any emojis 🪴🪴🪴(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="potted plant emoji 🪴 emoji 🪴🪴 copy and paste 🪴 emoji 🪴 emoji 🪴🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"potted plant emoji 🪴🪴🪴🪴 Copy and paste & Search for any emojis 🪴🪴🪴(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
