...
$_GET['emojiID']="654";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="cherry blossom emoji" description = "cherry blossom emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="cherry blossom emoji">🌸</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about cherry blossom emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="cherry blossom emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🌸</dd>
                                </dl>
...
<head>
    ...
    <title>cherry blossom emoji 🌸 emoji 🌸🌸 copy and paste 🌸 emoji 🌸 emoji 🌸🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="cherry blossom emoji 🌸🌸🌸🌸 Copy and paste & Search for any emojis 🌸🌸🌸(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="cherry blossom emoji 🌸 emoji 🌸🌸 copy and paste 🌸 emoji 🌸 emoji 🌸🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"cherry blossom emoji 🌸🌸🌸🌸 Copy and paste & Search for any emojis 🌸🌸🌸(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
