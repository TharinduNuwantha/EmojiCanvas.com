...
$_GET['emojiID']="595";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="turkey emoji" description = "turkey emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="turkey emoji">🦃</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about turkey emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="turkey emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🦃</dd>
                                </dl>
...
<head>
    ...
    <title>turkey emoji 🦃 emoji 🦃🦃 copy and paste 🦃 emoji 🦃 emoji 🦃🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="turkey emoji 🦃🦃🦃🦃 Copy and paste & Search for any emojis 🦃🦃🦃(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="turkey emoji 🦃 emoji 🦃🦃 copy and paste 🦃 emoji 🦃 emoji 🦃🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"turkey emoji 🦃🦃🦃🦃 Copy and paste & Search for any emojis 🦃🦃🦃(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
