...
$_GET['emojiID']="586";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="polar bear emoji" description = "polar bear emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="polar bear emoji">🐻‍❄️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about polar bear emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="polar bear emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🐻‍❄️</dd>
                                </dl>
...
<head>
    ...
    <title>polar bear emoji 🐻‍❄️ emoji 🐻‍❄️🐻‍❄️ copy and paste 🐻‍❄️ emoji 🐻‍❄️ emoji 🐻‍❄️🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="polar bear emoji 🐻‍❄️🐻‍❄️🐻‍❄️🐻‍❄️ Copy and paste & Search for any emojis 🐻‍❄️🐻‍❄️🐻‍❄️(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="polar bear emoji 🐻‍❄️ emoji 🐻‍❄️🐻‍❄️ copy and paste 🐻‍❄️ emoji 🐻‍❄️ emoji 🐻‍❄️🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"polar bear emoji 🐻‍❄️🐻‍❄️🐻‍❄️🐻‍❄️ Copy and paste & Search for any emojis 🐻‍❄️🐻‍❄️🐻‍❄️(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
