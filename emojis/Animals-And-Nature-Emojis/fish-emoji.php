...
$_GET['emojiID']="629";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="fish emoji" description = "fish emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="fish emoji">🐟</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about fish emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="fish emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🐟</dd>
                                </dl>
...
<head>
    ...
    <title>fish emoji 🐟 emoji 🐟🐟 copy and paste 🐟 emoji 🐟 emoji 🐟🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="fish emoji 🐟🐟🐟🐟 Copy and paste & Search for any emojis 🐟🐟🐟(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="fish emoji 🐟 emoji 🐟🐟 copy and paste 🐟 emoji 🐟 emoji 🐟🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"fish emoji 🐟🐟🐟🐟 Copy and paste & Search for any emojis 🐟🐟🐟(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
