...
$_GET['emojiID']="575";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="mouse face emoji" description = "mouse face emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="mouse face emoji">🐭</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about mouse face emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="mouse face emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🐭</dd>
                                </dl>
...
<head>
    ...
    <title>mouse face emoji 🐭 emoji 🐭🐭 copy and paste 🐭 emoji 🐭 emoji 🐭🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="mouse face emoji 🐭🐭🐭🐭 Copy and paste & Search for any emojis 🐭🐭🐭(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="mouse face emoji 🐭 emoji 🐭🐭 copy and paste 🐭 emoji 🐭 emoji 🐭🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"mouse face emoji 🐭🐭🐭🐭 Copy and paste & Search for any emojis 🐭🐭🐭(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
