...
$_GET['emojiID']="592";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="kangaroo emoji" description = "kangaroo emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="kangaroo emoji">🦘</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about kangaroo emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="kangaroo emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🦘</dd>
                                </dl>
...
<head>
    ...
    <title>kangaroo emoji 🦘 emoji 🦘🦘 copy and paste 🦘 emoji 🦘 emoji 🦘🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="kangaroo emoji 🦘🦘🦘🦘 Copy and paste & Search for any emojis 🦘🦘🦘(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="kangaroo emoji 🦘 emoji 🦘🦘 copy and paste 🦘 emoji 🦘 emoji 🦘🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"kangaroo emoji 🦘🦘🦘🦘 Copy and paste & Search for any emojis 🦘🦘🦘(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
