...
$_GET['emojiID']="624";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="T-Rex emoji" description = "T-Rex emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="T-Rex emoji">🦖</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about T-Rex emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="T-Rex emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🦖</dd>
                                </dl>
...
<head>
    ...
    <title>T-Rex emoji 🦖 emoji 🦖🦖 copy and paste 🦖 emoji 🦖 emoji 🦖🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="T-Rex emoji 🦖🦖🦖🦖 Copy and paste & Search for any emojis 🦖🦖🦖(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="T-Rex emoji 🦖 emoji 🦖🦖 copy and paste 🦖 emoji 🦖 emoji 🦖🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"T-Rex emoji 🦖🦖🦖🦖 Copy and paste & Search for any emojis 🦖🦖🦖(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
