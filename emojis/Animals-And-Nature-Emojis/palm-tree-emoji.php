...
$_GET['emojiID']="669";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="palm tree emoji" description = "palm tree emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="palm tree emoji">🌴</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about palm tree emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="palm tree emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🌴</dd>
                                </dl>
...
<head>
    ...
    <title>palm tree emoji 🌴 emoji 🌴🌴 copy and paste 🌴 emoji 🌴 emoji 🌴🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="palm tree emoji 🌴🌴🌴🌴 Copy and paste & Search for any emojis 🌴🌴🌴(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="palm tree emoji 🌴 emoji 🌴🌴 copy and paste 🌴 emoji 🌴 emoji 🌴🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"palm tree emoji 🌴🌴🌴🌴 Copy and paste & Search for any emojis 🌴🌴🌴(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
