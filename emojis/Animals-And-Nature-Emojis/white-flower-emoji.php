...
$_GET['emojiID']="655";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="white flower emoji" description = "white flower emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="white flower emoji">💮</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about white flower emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="white flower emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>💮</dd>
                                </dl>
...
<head>
    ...
    <title>white flower emoji 💮 emoji 💮💮 copy and paste 💮 emoji 💮 emoji 💮🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="white flower emoji 💮💮💮💮 Copy and paste & Search for any emojis 💮💮💮(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="white flower emoji 💮 emoji 💮💮 copy and paste 💮 emoji 💮 emoji 💮🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"white flower emoji 💮💮💮💮 Copy and paste & Search for any emojis 💮💮💮(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
