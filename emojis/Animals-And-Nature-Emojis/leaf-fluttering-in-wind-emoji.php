...
$_GET['emojiID']="677";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="leaf fluttering in wind emoji" description = "leaf fluttering in wind emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="leaf fluttering in wind emoji">🍃</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about leaf fluttering in wind emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="leaf fluttering in wind emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🍃</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>leaf fluttering in wind</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Animals & Nature</dd>
                                </dl>
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>leaves</dd>
...
<head>
    ...
    <title>leaf fluttering in wind emoji 🍃 emoji 🍃🍃 copy and paste 🍃 emoji 🍃 emoji 🍃🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="leaf fluttering in wind emoji 🍃🍃🍃🍃 Copy and paste & Search for any emojis 🍃🍃🍃(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="leaf fluttering in wind emoji 🍃 emoji 🍃🍃 copy and paste 🍃 emoji 🍃 emoji 🍃🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"leaf fluttering in wind emoji 🍃🍃🍃🍃 Copy and paste & Search for any emojis 🍃🍃🍃(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
