...
$_GET['emojiID']="563";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="pig nose emoji" description = "pig nose emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="pig nose emoji">🐽</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about pig nose emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="pig nose emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🐽</dd>
                                </dl>
...
<head>
    ...
    <title>pig nose emoji 🐽 emoji 🐽🐽 copy and paste 🐽 emoji 🐽 emoji 🐽🐵 🐒 🦍 🦧 🐶 🐕 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="pig nose emoji 🐽🐽🐽🐽 Copy and paste & Search for any emojis 🐽🐽🐽(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="pig nose emoji 🐽 emoji 🐽🐽 copy and paste 🐽 emoji 🐽 emoji 🐽🐵 🐒 🦍 🦧 🐶 🐕 " />
    <meta property="og:description"pig nose emoji 🐽🐽🐽🐽 Copy and paste & Search for any emojis 🐽🐽🐽(Animals & Nature)🐵 🐒 🦍 🦧 🐶 🐕 🦮 🐕‍🦺 🐩 🐺 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
