...
$_GET['emojiID']="1278";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="open file folder emoji" description = "open file folder emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="open file folder emoji">📂</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about open file folder emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="open file folder emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>📂</dd>
                                </dl>
...
<head>
    ...
    <title>open file folder emoji 📂 emoji 📂📂 copy and paste 📂 emoji 📂 emoji 📂👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="open file folder emoji 📂📂📂📂 Copy and paste & Search for any emojis 📂📂📂(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="open file folder emoji 📂 emoji 📂📂 copy and paste 📂 emoji 📂 emoji 📂👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"open file folder emoji 📂📂📂📂 Copy and paste & Search for any emojis 📂📂📂(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
