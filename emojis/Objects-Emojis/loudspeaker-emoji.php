...
$_GET['emojiID']="1168";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="loudspeaker emoji" description = "loudspeaker emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="loudspeaker emoji">📢</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about loudspeaker emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="loudspeaker emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>📢</dd>
                                </dl>
...
<head>
    ...
    <title>loudspeaker emoji 📢 emoji 📢📢 copy and paste 📢 emoji 📢 emoji 📢👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="loudspeaker emoji 📢📢📢📢 Copy and paste & Search for any emojis 📢📢📢(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="loudspeaker emoji 📢 emoji 📢📢 copy and paste 📢 emoji 📢 emoji 📢👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"loudspeaker emoji 📢📢📢📢 Copy and paste & Search for any emojis 📢📢📢(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
