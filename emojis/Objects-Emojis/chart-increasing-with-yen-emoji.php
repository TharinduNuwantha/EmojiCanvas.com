...
$_GET['emojiID']="1255";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="chart increasing with yen emoji" description = "chart increasing with yen emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="chart increasing with yen emoji">💹</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about chart increasing with yen emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="chart increasing with yen emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>💹</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>chart increasing with yen</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Objects</dd>
...
<head>
    ...
    <title>chart increasing with yen emoji 💹 emoji 💹💹 copy and paste 💹 emoji 💹 emoji 💹👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="chart increasing with yen emoji 💹💹💹💹 Copy and paste & Search for any emojis 💹💹💹(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="chart increasing with yen emoji 💹 emoji 💹💹 copy and paste 💹 emoji 💹 emoji 💹👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"chart increasing with yen emoji 💹💹💹💹 Copy and paste & Search for any emojis 💹💹💹(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
