...
$_GET['emojiID']="1197";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="pager emoji" description = "pager emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="pager emoji">📟</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about pager emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="pager emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>📟</dd>
                                </dl>
...
<head>
    ...
    <title>pager emoji 📟 emoji 📟📟 copy and paste 📟 emoji 📟 emoji 📟👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="pager emoji 📟📟📟📟 Copy and paste & Search for any emojis 📟📟📟(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="pager emoji 📟 emoji 📟📟 copy and paste 📟 emoji 📟 emoji 📟👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"pager emoji 📟📟📟📟 Copy and paste & Search for any emojis 📟📟📟(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
