...
$_GET['emojiID']="1222";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="magnifying glass tilted left emoji" description = "magnifying glass tilted left emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="magnifying glass tilted left emoji">🔍</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about magnifying glass tilted left emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="magnifying glass tilted left emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔍</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>magnifying glass tilted left</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Objects</dd>
...
<head>
    ...
    <title>magnifying glass tilted left emoji 🔍 emoji 🔍🔍 copy and paste 🔍 emoji 🔍 emoji 🔍👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="magnifying glass tilted left emoji 🔍🔍🔍🔍 Copy and paste & Search for any emojis 🔍🔍🔍(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="magnifying glass tilted left emoji 🔍 emoji 🔍🔍 copy and paste 🔍 emoji 🔍 emoji 🔍👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"magnifying glass tilted left emoji 🔍🔍🔍🔍 Copy and paste & Search for any emojis 🔍🔍🔍(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
