...
$_GET['emojiID']="1307";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="pick emoji" description = "pick emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="pick emoji">⛏️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about pick emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="pick emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>⛏️</dd>
                                </dl>
...
<head>
    ...
    <title>pick emoji ⛏️ emoji ⛏️⛏️ copy and paste ⛏️ emoji ⛏️ emoji ⛏️👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="pick emoji ⛏️⛏️⛏️⛏️ Copy and paste & Search for any emojis ⛏️⛏️⛏️(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="pick emoji ⛏️ emoji ⛏️⛏️ copy and paste ⛏️ emoji ⛏️ emoji ⛏️👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"pick emoji ⛏️⛏️⛏️⛏️ Copy and paste & Search for any emojis ⛏️⛏️⛏️(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
