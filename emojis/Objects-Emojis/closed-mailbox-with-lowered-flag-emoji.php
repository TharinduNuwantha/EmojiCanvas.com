...
$_GET['emojiID']="1264";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="closed mailbox with lowered flag emoji" description = "closed mailbox with lowered flag emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="closed mailbox with lowered flag emoji">📪</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about closed mailbox with lowered flag emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="closed mailbox with lowered flag emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>📪</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>closed mailbox with lowered flag</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Objects</dd>
...
<head>
    ...
    <title>closed mailbox with lowered flag emoji 📪 emoji 📪📪 copy and paste 📪 emoji 📪 emoji 📪👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="closed mailbox with lowered flag emoji 📪📪📪📪 Copy and paste & Search for any emojis 📪📪📪(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="closed mailbox with lowered flag emoji 📪 emoji 📪📪 copy and paste 📪 emoji 📪 emoji 📪👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"closed mailbox with lowered flag emoji 📪📪📪📪 Copy and paste & Search for any emojis 📪📪📪(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
