...
$_GET['emojiID']="1269";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="pencil emoji" description = "pencil emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="pencil emoji">✏️</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about pencil emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="pencil emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>✏️</dd>
                                </dl>
...
<head>
    ...
    <title>pencil emoji ✏️ emoji ✏️✏️ copy and paste ✏️ emoji ✏️ emoji ✏️👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="pencil emoji ✏️✏️✏️✏️ Copy and paste & Search for any emojis ✏️✏️✏️(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="pencil emoji ✏️ emoji ✏️✏️ copy and paste ✏️ emoji ✏️ emoji ✏️👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"pencil emoji ✏️✏️✏️✏️ Copy and paste & Search for any emojis ✏️✏️✏️(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
