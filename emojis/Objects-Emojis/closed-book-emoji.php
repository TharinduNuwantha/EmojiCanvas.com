...
$_GET['emojiID']="1230";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="closed book emoji" description = "closed book emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="closed book emoji">📕</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about closed book emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="closed book emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>📕</dd>
                                </dl>
...
<head>
    ...
    <title>closed book emoji 📕 emoji 📕📕 copy and paste 📕 emoji 📕 emoji 📕👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="closed book emoji 📕📕📕📕 Copy and paste & Search for any emojis 📕📕📕(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="closed book emoji 📕 emoji 📕📕 copy and paste 📕 emoji 📕 emoji 📕👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"closed book emoji 📕📕📕📕 Copy and paste & Search for any emojis 📕📕📕(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
