...
$_GET['emojiID']="1229";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="notebook with decorative cover emoji" description = "notebook with decorative cover emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="notebook with decorative cover emoji">📔</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about notebook with decorative cover emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="notebook with decorative cover emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>📔</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>notebook with decorative cover</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Objects</dd>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>notebook_with_decorative_cover</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>notebook with decorative cover emoji 📔 emoji 📔📔 copy and paste 📔 emoji 📔 emoji 📔👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="notebook with decorative cover emoji 📔📔📔📔 Copy and paste & Search for any emojis 📔📔📔(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="notebook with decorative cover emoji 📔 emoji 📔📔 copy and paste 📔 emoji 📔 emoji 📔👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"notebook with decorative cover emoji 📔📔📔📔 Copy and paste & Search for any emojis 📔📔📔(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
