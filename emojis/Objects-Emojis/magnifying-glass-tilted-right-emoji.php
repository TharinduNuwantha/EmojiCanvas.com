...
$_GET['emojiID']="1223";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="magnifying glass tilted right emoji" description = "magnifying glass tilted right emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="magnifying glass tilted right emoji">🔎</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about magnifying glass tilted right emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="magnifying glass tilted right emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🔎</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>magnifying glass tilted right</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Objects</dd>
...
<head>
    ...
    <title>magnifying glass tilted right emoji 🔎 emoji 🔎🔎 copy and paste 🔎 emoji 🔎 emoji 🔎👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="magnifying glass tilted right emoji 🔎🔎🔎🔎 Copy and paste & Search for any emojis 🔎🔎🔎(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="magnifying glass tilted right emoji 🔎 emoji 🔎🔎 copy and paste 🔎 emoji 🔎 emoji 🔎👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"magnifying glass tilted right emoji 🔎🔎🔎🔎 Copy and paste & Search for any emojis 🔎🔎🔎(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
