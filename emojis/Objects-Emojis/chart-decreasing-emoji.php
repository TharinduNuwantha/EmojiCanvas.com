...
$_GET['emojiID']="1286";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="chart decreasing emoji" description = "chart decreasing emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="chart decreasing emoji">📉</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about chart decreasing emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="chart decreasing emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>📉</dd>
                                </dl>
                                ...
                                <dl>
                                    <dt>Subcategory</dt>
                                    <dd>chart_with_downwards_trend</dd>
                                </dl>
                                <dl>
...
<head>
    ...
    <title>chart decreasing emoji 📉 emoji 📉📉 copy and paste 📉 emoji 📉 emoji 📉👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="chart decreasing emoji 📉📉📉📉 Copy and paste & Search for any emojis 📉📉📉(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="chart decreasing emoji 📉 emoji 📉📉 copy and paste 📉 emoji 📉 emoji 📉👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"chart decreasing emoji 📉📉📉📉 Copy and paste & Search for any emojis 📉📉📉(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
