...
$_GET['emojiID']="1265";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="open mailbox with raised flag emoji" description = "open mailbox with raised flag emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="open mailbox with raised flag emoji">📬</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about open mailbox with raised flag emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="open mailbox with raised flag emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>📬</dd>
                                </dl>
                                <dl>
                                    <dt>Description</dt>
                                    <dd>open mailbox with raised flag</dd>
                                </dl>
                                <dl>
                                    <dt>Category</dt>
                                    <dd>Objects</dd>
...
<head>
    ...
    <title>open mailbox with raised flag emoji 📬 emoji 📬📬 copy and paste 📬 emoji 📬 emoji 📬👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="open mailbox with raised flag emoji 📬📬📬📬 Copy and paste & Search for any emojis 📬📬📬(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="open mailbox with raised flag emoji 📬 emoji 📬📬 copy and paste 📬 emoji 📬 emoji 📬👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"open mailbox with raised flag emoji 📬📬📬📬 Copy and paste & Search for any emojis 📬📬📬(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
