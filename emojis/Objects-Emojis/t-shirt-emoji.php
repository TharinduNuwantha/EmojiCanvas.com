...
$_GET['emojiID']="1123";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="t-shirt emoji" description = "t-shirt emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="t-shirt emoji">👕</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about t-shirt emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="t-shirt emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>👕</dd>
                                </dl>
...
<head>
    ...
    <title>t-shirt emoji 👕 emoji 👕👕 copy and paste 👕 emoji 👕 emoji 👕👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="t-shirt emoji 👕👕👕👕 Copy and paste & Search for any emojis 👕👕👕(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="t-shirt emoji 👕 emoji 👕👕 copy and paste 👕 emoji 👕 emoji 👕👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"t-shirt emoji 👕👕👕👕 Copy and paste & Search for any emojis 👕👕👕(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
