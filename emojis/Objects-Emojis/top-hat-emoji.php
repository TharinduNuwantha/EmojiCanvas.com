...
$_GET['emojiID']="1155";if (isset($_GET['searchResult']) OR isset($_GET['emojiID'])) {
    ...
    if ($result_set) {
        ...
        if(mysqli_num_rows($result_set)>0){
            ...
            <div class="mainWapper">
                <div class="mainContainer">
                    ...
                    <div class="line"></div>
                    <br><br>
                    <div class="imojiBox" title="top hat emoji" description = "top hat emoji copy and paste">
                        <div class="imojiMdBox">
                            <div class="mainImoj">
                                <span class="imjSpan" title="top hat emoji">🎩</span>
                            </div>
                    ...
                    <div class="description">
                        <p title="description about top hat emoji">';
        ...
        <div class="line"></div><br><br>
                        ...
                        <div class="dtlTable">
                            <div class="tblCanves" title="top hat emoji full details table">
                                <dl>
                                    <dt>Emoji</dt>
                                    <dd>🎩</dd>
                                </dl>
...
<head>
    ...
    <title>top hat emoji 🎩 emoji 🎩🎩 copy and paste 🎩 emoji 🎩 emoji 🎩👓 🕶️ 🥽 🥼 🦺 👔 </title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="../MasterStyle/style.css">
    <link rel="stylesheet" href="../emojiCategories/redHartTest/style.css">
    <meta name="description" content="top hat emoji 🎩🎩🎩🎩 Copy and paste & Search for any emojis 🎩🎩🎩(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅"> 
    ...
    <meta property="og:title" content="top hat emoji 🎩 emoji 🎩🎩 copy and paste 🎩 emoji 🎩 emoji 🎩👓 🕶️ 🥽 🥼 🦺 👔 " />
    <meta property="og:description"top hat emoji 🎩🎩🎩🎩 Copy and paste & Search for any emojis 🎩🎩🎩(Objects)👓 🕶️ 🥽 🥼 🦺 👔 👕 👖 🧣 🧤 ❤️🎉🔥💜✨💖👀💯💙🎈❣️💋💔💚🖤💛⭐💝🔴✅" />
